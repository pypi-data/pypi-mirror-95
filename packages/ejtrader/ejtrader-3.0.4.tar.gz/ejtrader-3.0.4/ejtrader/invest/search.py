...
def search_quotes(text, products=None, countries=None, n_results=None):
    ...
    introduced text. This function will create a :obj:`list` of :obj:`ejtrader.utils.search_obj.SearchObj`
    ...
    Returns:
        :obj:`list` of :obj:`ejtrader.utils.search_obj.SearchObj`:
            The resulting :obj:`list` of :obj:`ejtrader.utils.search_obj.SearchObj` will contained the retrieved
