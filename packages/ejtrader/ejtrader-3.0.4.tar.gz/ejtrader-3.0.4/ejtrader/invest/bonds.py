...
def get_bond_recent_data(bond, as_json=False, order='ascending', interval='Daily'):
    ...
    Examples:
        >>> data = ejtrader.get_bond_recent_data(bond='Argentina 3Y')
        >>> data.head()
                      Open    High     Low   Close
        Date                                      
    ...
    resource_path = '/'.join(('/invest/resources', 'bonds.csv'))
...
def get_bond_historical_data(bond, from_date, to_date, as_json=False, order='ascending', interval='Daily'):
    ...
    Examples:
        >>> data = ejtrader.get_bond_historical_data(bond='Argentina 3Y', from_date='01/01/2010', to_date='01/01/2019')
        >>> data.head()
                    Open  High   Low  Close
        Date                               
