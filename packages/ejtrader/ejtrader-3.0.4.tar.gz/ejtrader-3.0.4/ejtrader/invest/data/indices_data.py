...
def indices_as_df(country=None):
    """
    This function retrieves all the available `indices` from Investing.com as previously listed in ejtrader, and
    ...
    Returns:
        :obj:`pandas.DataFrame` - indices_df:
            ...
            as previously listed by ejtrader.
    ...
    Raises:
        ...
        IOError: raised if the `indices.csv` file from `ejtrader` is missing or errored.
    ...
    resource_path = '/'.join(('/invest/resources', 'indices.csv'))
