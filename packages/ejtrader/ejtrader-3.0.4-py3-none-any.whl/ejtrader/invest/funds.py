...
def get_fund_recent_data(fund, country, as_json=False, order='ascending', interval='Daily'):
    ...
    Examples:
        >>> data = ejtrader.get_fund_recent_data(fund='bbva multiactivo conservador pp', country='spain')
        >>> data.head()
    ...
    resource_path = '/'.join(('/invest/resources', 'funds.csv'))
...
def get_fund_historical_data(fund, country, from_date, to_date, as_json=False, order='ascending', interval='Daily'):
    ...
    Examples:
        >>> data = ejtrader.get_fund_historical_data(fund='bbva multiactivo conservador pp', country='spain', from_date='01/01/2010', to_date='01/01/2019')
        >>> data.head()
                     Open   High    Low  Close Currency
        Date
