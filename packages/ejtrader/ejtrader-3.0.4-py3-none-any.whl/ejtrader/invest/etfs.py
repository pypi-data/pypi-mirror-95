...
def get_etfs(country=None):
    ...
    Returns:
        :obj:`pandas.DataFrame` - etfs:
            ...
            was previously retrieved by ejtrader. Unless the country is specified, all the available etfs indexed on 
...
def get_etf_recent_data(etf, country, stock_exchange=None, as_json=False, order='ascending', interval='Daily'):
    ...
    Examples:
        >>> data = ejtrader.get_etf_recent_data(etf='bbva accion dj eurostoxx 50', country='spain')
        >>> data.head()
    ...
    resource_path = '/'.join(('/invest/resources', 'etfs.csv'))
...
def get_etf_historical_data(etf, country, from_date, to_date, stock_exchange=None, as_json=False, order='ascending', interval='Daily'):
    ...
    Examples:
        >>> data = ejtrader.get_etf_historical_data(etf='bbva accion dj eurostoxx 50', country='spain', from_date='01/01/2010', to_date='01/01/2019')
        >>> data.head()
                     Open   High    Low  Close  Volume Currency Exchange
        Date                                                            
