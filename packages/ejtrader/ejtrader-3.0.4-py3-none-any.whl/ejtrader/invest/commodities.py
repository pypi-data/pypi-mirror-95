...
def get_commodity_recent_data(commodity, country=None, as_json=False, order='ascending', interval='Daily'):
    ...
    Examples:
        >>> data = ejtrader.get_commodity_recent_data(commodity='gold')
        >>> data.head()
    ...
    resource_path = '/'.join(('/invest/resources', 'commodities.csv'))
...
def get_commodity_historical_data(commodity, from_date, to_date, country=None, as_json=False, order='ascending', interval='Daily'):
    ...
    Examples:
        >>> data = ejtrader.get_historical_data(commodity='gold', from_date='01/01/2018', to_date='01/01/2019')
        >>> data.head()
                      Open    High     Low   Close  Volume Currency
        Date                                                       
