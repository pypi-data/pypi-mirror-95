...
class indicators:
    ...
    def ER(cls, ohlc: DataFrame, period: int = 10, column: str = "close") -> Series:
        """The Kaufman Efficiency indicator is an oscillator indicator that oscillates between +100 and -100, where zero is the center point.
         +100 is upward forex_currency trending market and -100 is downwards trending markets."""
    ...
    def BBANDS(
        ...
        """
         ...
         Pass desired moving average as <MA> argument. For example BBANDS(MA=indicators.KAMA(20)).
         """
    ...
    def PERCENT_B(
        ...
        BB = indicators.BBANDS(ohlc, period, MA, column)
        percent_b = pd.Series(
    ...
    @classmethod
    def WILLIAMS_FRACindicatorsL(cls, ohlc: DataFrame, period: int = 2) -> DataFrame:
        """
...
if __name__ == "__main__":
    print([k for k in indicators.__dict__.keys() if k[0] not in "_"])