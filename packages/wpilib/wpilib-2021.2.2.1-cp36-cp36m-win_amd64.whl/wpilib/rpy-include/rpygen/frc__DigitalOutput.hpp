...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__DigitalOutput : PyBasefrc__DigitalOutput<PyTrampolineBase, CxxBase> {
    using PyBasefrc__DigitalOutput<PyTrampolineBase, CxxBase>::PyBasefrc__DigitalOutput;
