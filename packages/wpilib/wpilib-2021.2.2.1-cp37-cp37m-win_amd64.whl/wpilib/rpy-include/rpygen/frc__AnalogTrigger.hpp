...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__AnalogTrigger : PyBasefrc__AnalogTrigger<PyTrampolineBase, CxxBase> {
    using PyBasefrc__AnalogTrigger<PyTrampolineBase, CxxBase>::PyBasefrc__AnalogTrigger;
