...
#define RPYGEN_DISABLE_SetMaxPeriod_d
...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__Counter : PyBasefrc__Counter<PyTrampolineBase, CxxBase> {
    using PyBasefrc__Counter<PyTrampolineBase, CxxBase>::PyBasefrc__Counter;
