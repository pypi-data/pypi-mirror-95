...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__AnalogTriggerOutput : PyBasefrc__AnalogTriggerOutput<PyTrampolineBase, CxxBase> {
    using PyBasefrc__AnalogTriggerOutput<PyTrampolineBase, CxxBase>::PyBasefrc__AnalogTriggerOutput;
...
PyBasefrc__AnalogTriggerOutput<PyTrampolineBase, CxxBase>(trigger, outputType)
    {}
#endif
