...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__AnalogEncoder : PyBasefrc__AnalogEncoder<PyTrampolineBase, CxxBase> {
    using PyBasefrc__AnalogEncoder<PyTrampolineBase, CxxBase>::PyBasefrc__AnalogEncoder;
