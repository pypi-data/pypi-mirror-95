...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__ADXL362 : PyBasefrc__ADXL362<PyTrampolineBase, CxxBase> {
    using PyBasefrc__ADXL362<PyTrampolineBase, CxxBase>::PyBasefrc__ADXL362;
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(ADXL362::AllAxes), CxxBase, "getAccelerations", GetAccelerations,);    }
#endif
