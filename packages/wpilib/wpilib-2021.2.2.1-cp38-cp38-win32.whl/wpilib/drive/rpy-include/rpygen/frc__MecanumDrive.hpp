...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__MecanumDrive : PyBasefrc__MecanumDrive<PyTrampolineBase, CxxBase> {
    using PyBasefrc__MecanumDrive<PyTrampolineBase, CxxBase>::PyBasefrc__MecanumDrive;
