...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__PySpeedControllerGroup : PyBasefrc__PySpeedControllerGroup<PyTrampolineBase, CxxBase> {
    using PyBasefrc__PySpeedControllerGroup<PyTrampolineBase, CxxBase>::PyBasefrc__PySpeedControllerGroup;
