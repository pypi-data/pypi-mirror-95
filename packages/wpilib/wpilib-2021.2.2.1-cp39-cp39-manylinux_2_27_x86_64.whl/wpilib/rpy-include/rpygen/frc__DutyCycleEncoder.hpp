...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__DutyCycleEncoder : PyBasefrc__DutyCycleEncoder<PyTrampolineBase, CxxBase> {
    using PyBasefrc__DutyCycleEncoder<PyTrampolineBase, CxxBase>::PyBasefrc__DutyCycleEncoder;
