...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__DifferentialDrive : PyBasefrc__DifferentialDrive<PyTrampolineBase, CxxBase> {
    using PyBasefrc__DifferentialDrive<PyTrampolineBase, CxxBase>::PyBasefrc__DifferentialDrive;
