...
[boto3.ServerlessApplicationRepository 1.17.9](https://boto3.amazonaws.com/v1/documentation/api/1.17.9/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
compatible with
