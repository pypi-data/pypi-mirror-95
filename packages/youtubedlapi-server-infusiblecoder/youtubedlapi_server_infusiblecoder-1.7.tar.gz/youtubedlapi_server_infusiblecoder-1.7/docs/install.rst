...
How to install **youtubedlapi_server_infusiblecoder**

Using pip
*********
Just run :command:`pip install --pre youtubedlapi_server_infusiblecoder`.

Then you can start using the server with :program:`youtubedlapi_server_infusiblecoder`.
...
Alternatively you can use pip to install it, run :command:`pip install -e .` and then you'll be able to run :program:`youtubedlapi_server_infusiblecoder` (you won't need to rerun the pip command if you do some changes).
