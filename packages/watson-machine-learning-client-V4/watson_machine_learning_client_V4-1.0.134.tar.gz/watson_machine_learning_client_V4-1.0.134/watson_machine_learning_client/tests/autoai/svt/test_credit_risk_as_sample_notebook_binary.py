...
from watson_machine_learning_client.helpers.connections import S3Connection, S3Location, DataConnection, WMLSAssetLocation

from watson_machine_learning_client.tests.utils import get_wml_credentials, get_cos_credentials, bucket_exists, bucket_name_gen, get_space_id
from watson_machine_learning_client.tests.utils.cleanup import bucket_cleanup, space_cleanup
from watson_machine_learning_client.utils.autoai.enums import PositiveLabelClass, TShirtSize

from watson_machine_learning_client.utils.autoai.errors import MissingPositiveLabel, AutoAIComputeError
...
class TestAutoAIRemote(unittest.TestCase):
    ...
    def setUp(cls) -> None:
        ...
        if not (cls.wml_client.ICP or cls.wml_client.WSD):
