...
from watson_machine_learning_client.tests.utils import get_wml_credentials, get_cos_credentials
from watson_machine_learning_client import WatsonMachineLearningAPIClient
from watson_machine_learning_client.experiment.autoai.engines import WMLEngine
from watson_machine_learning_client.helpers import S3Connection, S3Location, DataConnection
from watson_machine_learning_client.utils.autoai.errors import HoldoutSplitNotSupported
...
class TestDataConnection(unittest.TestCase):
    ...
    def test_04_read_logs__download_logs_from_filesystem(self):
        wml_client = WatsonMachineLearningAPIClient(self.wml_credentials_cp4d,
