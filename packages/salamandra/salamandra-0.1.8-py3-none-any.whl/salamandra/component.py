...
def sort_(pattern=None, addition=None):
...
class Component(Object):
    ...
    def write_netlist(self):
        ...
        # subcircuits
        for sub in sorted(self.get_descendants(), key=lambda c: sort_()(c.get_object_name())):  # sort by names
            ...
            # instances
            for inst in sorted(sub.subcomponent_names()):
