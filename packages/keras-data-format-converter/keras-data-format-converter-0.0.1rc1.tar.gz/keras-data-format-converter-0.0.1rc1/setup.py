...
setup(name='keras-data-format-converter',
      version="0.0.1rc1",
      description='Generating equal keras models with the desired data format',
      long_description=long_description,
      long_description_content_type='text/markdown',
      url='https://github.com/tensorleap/keras-data-format-converter',
      download_url='https://github.com/tensorleap/keras-data-format-converter/archive/v0.0.1rc1.tar.gz',
