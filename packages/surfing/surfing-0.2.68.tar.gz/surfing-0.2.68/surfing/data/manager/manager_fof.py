...
class FOFDataManager(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        self._other_record: Optional[pd.DataFrame] = None
    ...
    def init(self):
        ...
        other_record = BasicDataApi().get_fof_other_record([FOFDataManager._FOF_ID])
        self._other_record = other_record.set_index('date')
    ...
    def calc_fof_nav(self, is_from_excel=False):
        ...
        if is_from_excel:
            ...
            for date in self._date_list:
                ...
                try:
                    other_record = self._other_record.loc[[date], :]
                except KeyError:
                    other_record = None
                ...
                if other_record is not None:
                    fee_transfer = other_record.loc[other_record.event_type.isin([FOFStatementStatus.OUT_MANAGEMENT, FOFStatementStatus.OUT_CUSTODIAN, FOFStatementStatus.OUT_ADMINISTRATIVE]), 'amount']
                ...
                #     pass
                if other_record is not None:
                    cash_interest = other_record.loc[other_record.event_type.isin([FOFStatementStatus.IN_INTEREST, FOFStatementStatus.IN_OTHER_IN]), 'amount']
                    if not cash_interest.empty:
                        cash_interest = round(cash_interest.sum(), 2)
                        total_cash += cash_interest

                    other_fees = other_record.loc[other_record.event_type.isin([FOFStatementStatus.OUT_OTHER_OUT]), 'amount']
                ...
                #     pass
                if other_record is not None:
                    cd_interest_transfer = other_record.loc[other_record.event_type.isin([FOFStatementStatus.IN_INTEREST]), 'amount']
