...
class UsersApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str first_name__contains: first_name__contains
        :param str first_name__icontains: first_name__icontains
        :param str first_name__iexact: first_name__iexact
        :param str first_name__in: first_name__in
        :param str is_active: is_active
        :param str is_staff: is_staff
        :param str last_name: last_name
        :param str last_name__contains: last_name__contains
        :param str last_name__icontains: last_name__icontains
        :param str last_name__iexact: last_name__iexact
        :param str last_name__in: last_name__in
