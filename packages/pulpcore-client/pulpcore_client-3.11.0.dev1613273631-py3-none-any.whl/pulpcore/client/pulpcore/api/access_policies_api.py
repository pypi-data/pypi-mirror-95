...
class AccessPoliciesApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str customized: customized
        :param int limit: Number of results to return per page.
        :param int offset: The initial index from which to return the results.
        :param str ordering: Which field to use when ordering the results.
        :param str viewset_name: viewset_name
        :param str viewset_name__contains: viewset_name__contains
        :param str viewset_name__icontains: viewset_name__icontains
        :param str viewset_name__in: viewset_name__in
        :param str viewset_name__startswith: viewset_name__startswith
