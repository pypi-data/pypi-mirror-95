...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, content_guard=None, pulp_created=None, name=None, base_path=None, pulp_href=None, repository_version=None, repository=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
