...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, pulp_labels=None, repository=None, name=None, base_path=None, content_guard=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
