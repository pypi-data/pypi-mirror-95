...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, repository_version=None, content_guard=None, name=None, base_path=None, pulp_labels=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
