...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, content_guard=None, pulp_href=None, base_path=None, pulp_created=None, name=None, repository=None, pulp_labels=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
