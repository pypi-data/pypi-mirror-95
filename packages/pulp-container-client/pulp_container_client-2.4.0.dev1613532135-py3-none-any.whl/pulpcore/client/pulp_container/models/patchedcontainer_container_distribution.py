...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, pulp_labels=None, content_guard=None, repository_version=None, base_path=None, repository=None, name=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
