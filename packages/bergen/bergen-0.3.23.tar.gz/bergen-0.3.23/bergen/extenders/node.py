...
from bergen.extenders.ui.assignation import AssignationUIMixin
...
class NodeExtender(AssignationUIMixin, BaseExtender):
    ...
    def __call__(self, inputs: dict = None, params: AssignationParams = None, with_progress = False, **kwargs) -> dict:
