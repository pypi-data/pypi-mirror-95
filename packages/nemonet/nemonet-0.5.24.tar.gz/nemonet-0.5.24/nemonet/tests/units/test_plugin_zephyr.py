...
class MyTestCase(unittest.TestCase):
    ...
    def test_read_json(self):
        ...
        self.assertTrue( data.plugin[0].zephyr.jira_client_access_key == 'A' )
        self.assertTrue(data.plugin[0].zephyr.jira_client_secret_key == 'B')
        self.assertTrue(data.plugin[0].zephyr.zapi_client_access_key == 'C')
        self.assertTrue(data.plugin[0].zephyr.zapi_client_secret_key == 'D')
