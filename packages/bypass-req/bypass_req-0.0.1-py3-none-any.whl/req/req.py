...
class Req:
    def __init__(self):
        self.h = {
            "Referer": self.__random_referer__(),
            "User-Agent": self.__random_useragent__(),
        }
        self.timeout = 1

    def __random_useragent__(self):
        headers_useragents = []
    ...
    def get(self, *args, **kwargs):
        ...
        return sgrequests.SgRequests().get(*args, **kwargs, headers=self.h)

    def post(self, *args, **kwargs):
        time.sleep(self.timeout)
        return sgrequests.SgRequests().post(*args, **kwargs, headers=self.h)

    def put(self, *args, **kwargs):
        time.sleep(self.timeout)
        return sgrequests.SgRequests().put(*args, **kwargs, headers=self.h)

    def delete(self, *args, **kwargs):
        time.sleep(self.timeout)
        return sgrequests.SgRequests().delete(*args, **kwargs, headers=self.h)

    def head(self, *args, **kwargs):
        time.sleep(self.timeout)
        return sgrequests.SgRequests().head(*args, **kwargs, headers=self.h)

    def useRequestFunction(self):
        time.sleep(self.timeout)
        return sgrequests.SgRequests()
