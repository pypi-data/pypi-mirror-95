...
class ContentPackagesApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str requires_python: requires_python
        :param str requires_python__contains: requires_python__contains
        :param str requires_python__in: requires_python__in
