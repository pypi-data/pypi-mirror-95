define([
    ...
    var CreateGroup = function(blockContainerThis, id, name, container, level = 0) {
    ...
    CreateGroup.prototype.render = function() {
        ...
        sbCreateGroupBtn.appendFormatLine('<div class="{0}">', 'vp-block-blocktab-group-box vp-apiblock-minimize');
        ...
        sbCreateGroupBtn.appendFormatLine('<div class="{0}">', 'vp-apiblock-panel-area-vertical-btn vp-apiblock-arrow-down');
