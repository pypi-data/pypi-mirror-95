define([
    ...
    */
    ...
    BlockContainer.prototype.resizeAPIblock = function() {
        ...
        var optionPageRectWidth = mainPageRectWidthNum - boardPageRectWidth - buttonsPageRectWidth - 43;

        if (optionPageRectWidth < NUM_OPTION_PAGE_WIDTH) {
            boardPageRectWidth = mainPageRectWidthNum - NUM_OPTION_PAGE_WIDTH - 43 - buttonsPageRectWidth;
            // optionPageRectWidth = NUM_OPTION_PAGE_WIDTH;
        } 
        
        var optionPageRectWidth_maxWidth = mainPageRectWidthNum - buttonsPageRectWidth - NUM_API_BOARD_CENTER_PAGE_MIN_WIDTH - 43;
