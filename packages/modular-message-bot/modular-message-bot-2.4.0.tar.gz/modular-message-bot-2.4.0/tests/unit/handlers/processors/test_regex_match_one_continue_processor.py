...
from modular_message_bot.handlers.processors.regex_match_one_continue_processor import RegexMatchOneContinueProcessor
...
def test_get_code():
    ...
    # When
    result = RegexMatchOneContinueProcessor.get_code()

    # Then
    assert result == "regex_match_one_continue"
...
def test_process_match_all():
    ...
    # When
    processor = RegexMatchOneContinueProcessor(
        mock_config, mock_dynamic_config_interpolator, mock_job_string_interpolator
    )
...
def test_process_match_first():
    ...
    # When
    processor = RegexMatchOneContinueProcessor(mock_config, mock_dynamic_config_interpolator, mock_job_str_interpolator)
    is_continue = processor.process(parameters, job_run_vars_collection)
