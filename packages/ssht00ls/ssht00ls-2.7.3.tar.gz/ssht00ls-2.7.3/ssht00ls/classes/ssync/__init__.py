...
class SSync(object):
	...
	class Daemon(syst3m.objects.Thread):
		...
		def local_to_remote(self, path, info, directory=False, empty_directory=False, forced=False, delete=False):
		...
		def remote_to_local(self, path, info, directory=False, empty_directory=False, forced=False, delete=False):
