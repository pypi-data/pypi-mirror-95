...
def data_preprocessing(url):
    ...
    #rule_map = pd.read_excel("C:\\Users\\bpizzanimendoza\\AppData\\Local\\Continuum\\anaconda3\\lib\\site-packages\\rule_servant_pizzani\\rules.xlsx",index_col=0)
    rule_map = read(data_dir)
