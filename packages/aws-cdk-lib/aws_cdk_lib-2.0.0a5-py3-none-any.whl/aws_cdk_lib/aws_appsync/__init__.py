...
class _IGraphqlApiProxy(
    ...
    def add_rds_data_source(
        ...
        *,
        ...
        return typing.cast("RdsDataSource", jsii.invoke(self, "addRdsDataSource", [id, database_cluster, secret_store, database_name, options]))
...
class RdsDataSourceProps(BackedDataSourceProps):
    ...
    def database_cluster(self) -> _IDatabaseCluster_4a476608:
        ...
        return typing.cast(_IDatabaseCluster_4a476608, result)
