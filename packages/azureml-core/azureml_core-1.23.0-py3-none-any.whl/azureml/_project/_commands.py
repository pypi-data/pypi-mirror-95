...
def create_workspace(auth, resource_group_name, workspace_name, subscription_id,
    ...
    :param system_datastores_auth_mode: Determines whether or not to use credentials for the system datastores of the workspace 'workspaceblobstore' and 'workspacefilestore'. The default value is 'accesskey', in which case, the workspace will create the system datastores with credentials.  If set to 'identity', the workspace will create the system datastores with no credentials.
