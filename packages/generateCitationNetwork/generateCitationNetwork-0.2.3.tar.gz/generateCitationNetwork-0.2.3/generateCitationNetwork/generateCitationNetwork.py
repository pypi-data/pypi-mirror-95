...
class GenerateCitationNet():
    ...
    def getCitationsDF(self, doi):
        flDict = {
            'rows': 1,
            'fl': 'DOI,reference-count,is-referenced-by-count,author.family,title,published-print.date-parts,issued.date-parts,published-online.date-parts,container-title,reference.DOI,reference.unstructured'
            }
        ...
        if direct == 'cite':
            ...
            if dfRes.shape[0] > 0:
                ...
                if debug:
                    ...
                    # # TODO: For some edge cases there is no column sourceYear. How is that possible? Check DOI: 10.1007/bf00626622
