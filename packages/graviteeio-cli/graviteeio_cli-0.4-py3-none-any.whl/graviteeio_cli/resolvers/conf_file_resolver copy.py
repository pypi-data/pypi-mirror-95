...
from graviteeio_cli.resolvers.conf_resolver import Config_Type

logger = logging.getLogger("class-config_file_resolver")


class ConfigFileResolver:

    def __init__(self, resources_folder, values_file_path=None):
        super().__init__(resources_folder, values_file_path=None)
