...
def delete_file(instance, field_name, file_, using):
    ...
    # if our file is in one of the ignore directories don't delete
    file_name = file_.name
    file_location = file_name[0:file_name.rfind('/')]


    if file_location in settings.DJANGO_CLEANUP_IGNORE_DIRECTORIES:
        return
