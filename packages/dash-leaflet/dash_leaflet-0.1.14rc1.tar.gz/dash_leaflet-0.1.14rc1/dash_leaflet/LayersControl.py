...
- baseLayer (string; optional): Name of the currently selected base layer.
- overlays (list of strings; optional): Names of the currently selected overlays."""
    @_explicitize_args
    def __init__(self, children=None, collapsed=Component.UNDEFINED, position=Component.UNDEFINED, className=Component.UNDEFINED, id=Component.UNDEFINED, baseLayer=Component.UNDEFINED, overlays=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'collapsed', 'position', 'className', 'id', 'baseLayer', 'overlays']
        self._type = 'LayersControl'
        self._namespace = 'dash_leaflet'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'collapsed', 'position', 'className', 'id', 'baseLayer', 'overlays']
