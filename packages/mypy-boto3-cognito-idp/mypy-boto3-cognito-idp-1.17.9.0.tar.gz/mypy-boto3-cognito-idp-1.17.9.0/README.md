...
[boto3.CognitoIdentityProvider 1.17.9](https://boto3.amazonaws.com/v1/documentation/api/1.17.9/reference/services/cognito-idp.html#CognitoIdentityProvider) service
compatible with
