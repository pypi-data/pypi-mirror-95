...
from utils.utils import get_neighs_order, get_upsample_order
from utils.utils_vtk import read_vtk
from utils.utils_torch import getEn, get_bi_inter, getOverlapIndex
from utils.utils_groupwise_reg import DeformPool
...
def createRegConfig(config):
    ...
    for n_vertex in n_vertexs:
        tmp = get_neighs_order('neigh_indices/adj_mat_order_'+ str(n_vertex) +'_rotated_' + str(0) + '.mat')
    ...
    config['atlas'] = read_vtk('/media/fenqiang/DATA/unc/Data/GroupwiseReg/scripts/neigh_indices/sphere_' + \
