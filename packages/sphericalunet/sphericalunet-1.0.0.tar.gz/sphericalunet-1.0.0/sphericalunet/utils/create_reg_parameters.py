...
def get_fixed_xyz(n_vertex, device):
    fixed_0 = read_vtk('neigh_indices/sphere_' + str(n_vertex) +'_rotated_0.vtk')
    ...
    # fixed_1 = read_vtk('neigh_indices/sphere_' + str(n_vertex) +'_rotated_1.vtk')
    ...
    # fixed_2 = read_vtk('neigh_indices/sphere_' + str(n_vertex) +'_rotated_2.vtk')
...
def createRegConfig(config):
    ...
    config['atlas'] = read_vtk('neigh_indices/sphere_' + \
