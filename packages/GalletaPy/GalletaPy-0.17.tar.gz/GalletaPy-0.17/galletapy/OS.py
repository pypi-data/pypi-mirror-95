...
def HRR_OS1(i,j,k,l,N,pairAB,pairCD):
    ...
    for xyz in range(3):
        if(l[xyz]!=0):
            ...
            kp1 = k[:]
            kp1[xyz] = kp1[xyz] + 1
            return HRR_OS1(i,j,kp1,lm1,pairAB,pairCD,N) + (pairCD.g_a.coord[xyz]-pairCD.g_b.coord[xyz],0)*HRR_OS1(i,j,k,lm1,pairAB,pairCD,N)
        elif(j[xyz]!=0):
            jm1 = j[:]
            jm1[xyz] = jm1[xyz] - 1
            ip1 = i[:]
            ip1[xyz] = ip1[xyz] + 1
            return HRR_OS1(ip1,jm1,k,l,pairAB,pairCD,N) + (pairAB.g_a.coord[xyz]-pairAB.g_b.coord[xyz])*HRR_OS1(i,jm1,k,l,pairAB,pairCD,N)
