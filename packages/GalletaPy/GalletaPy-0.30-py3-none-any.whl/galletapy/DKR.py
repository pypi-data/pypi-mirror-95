...
def trans_elec_DKR1(i,j,k,l,pairAB,pairCD,ii,jj):
    ...
    for xyz in range(3):
        if(i[xyz]<0 or k[xyz]<0):
            ...
            ip1 = i[:]
            ip1[xyz] = ip1[xyz] + 1        
            return -(pairAB.ab[ii][1]*(pairAB.g_a.coord[xyz]-pairAB.g_b.coord[xyz])+pairCD.ab[jj][1]*(pairCD.g_c.coord[xyz]-pairCD.g_d.coord[xyz]))/pairCD.exp[jj]*trans_elec_DKR1(i,j,km1,l,pairAB,pairCD) + i[xyz]/(2*pairCD.exp[jj])*trans_elec_DKR1(im1,j,km1,l,pairAB,pairCD) + (k[xyz]-1)/(2*pairCD.exp[jj])*trans_elec_DKR1(i,j,km2,l,pairAB,pairCD) - pairAB.exp[ii]/pairCD.exp[jj]*trans_elec_DKR1(ip1,j,km1,l,pairAB,pairCD)
