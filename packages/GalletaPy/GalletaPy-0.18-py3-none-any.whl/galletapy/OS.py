...
def HRR_OS1(i,j,k,l,N,pairAB,pairCD):
    ...
    for xyz in range(3):
        if(l[xyz]!=0):
            ...
            kp1 = k[:]
            kp1[xyz] = kp1[xyz] + 1
            return HRR_OS1(i,j,kp1,lm1,N,pairAB,pairCD) + (pairCD.g_a.coord[xyz]-pairCD.g_b.coord[xyz],0)*HRR_OS1(i,j,k,lm1,N,pairAB,pairCD)
        elif(j[xyz]!=0):
            jm1 = j[:]
            jm1[xyz] = jm1[xyz] - 1
            ip1 = i[:]
