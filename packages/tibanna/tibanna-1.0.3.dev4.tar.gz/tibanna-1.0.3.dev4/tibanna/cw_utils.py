...
class TibannaResource(object):
    ...
    def __init__(self, instance_id, filesystem, starttime, endtime=datetime.utcnow(), cost_estimate = 4.0):
    ...
    def update_html(cls, bucket, prefix, directory='.', upload_new=True):
        ...
        estimated_cost = (float)(d['Estimated_Cost']) if 'Estimated_Cost' in d else 3.0
