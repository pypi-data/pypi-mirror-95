...
class PUTRenewSubscriptionType(object):
    ...
    def __init__(self, application_order=None, apply_credit=None, apply_credit_balance=None, collect=False, document_date=None, invoice=None, invoice_collect=True, invoice_target_date=None, run_billing=False, target_date=None):  # noqa: E501
