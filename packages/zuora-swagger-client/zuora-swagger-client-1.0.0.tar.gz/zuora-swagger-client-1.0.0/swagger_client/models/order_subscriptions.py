...
class OrderSubscriptions(object):
    ...
    def __init__(self, base_version=None, custom_fields=None, new_version=None, order_actions=None, quote=None, ramp=None, sequence=None, subscription_number=None):  # noqa: E501
