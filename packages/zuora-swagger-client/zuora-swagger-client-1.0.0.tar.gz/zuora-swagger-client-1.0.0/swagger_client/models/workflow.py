...
class Workflow(object):
    ...
    def __init__(self, callout_trigger=None, created_at=None, description=None, id=None, interval=None, name=None, ondemand_trigger=None, scheduled_trigger=None, timezone=None, type=None, updated_at=None):  # noqa: E501
