...
class UpdateTask(object):
    ...
    def concurrent_limit(self, concurrent_limit):
        ...
        :type: int
        """
        if concurrent_limit is not None and concurrent_limit > 9999999:  # noqa: E501
            raise ValueError("Invalid value for `concurrent_limit`, must be a value less than or equal to `9999999`")  # noqa: E501
        if concurrent_limit is not None and concurrent_limit < 1:  # noqa: E501
    ...
    def workflow_id(self):
        ...
        The ID of the workflow the task belongs too.   # noqa: E501
