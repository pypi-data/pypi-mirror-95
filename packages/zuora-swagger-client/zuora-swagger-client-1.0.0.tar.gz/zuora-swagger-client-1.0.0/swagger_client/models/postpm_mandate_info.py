...
class POSTPMMandateInfo(object):
    ...
    def mit_transaction_id(self, mit_transaction_id):
        ...
        :type: str
        """
        if mit_transaction_id is not None and len(mit_transaction_id) > 128:
