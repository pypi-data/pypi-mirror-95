...
class POSTOrderRequestType(object):
    ...
    def __init__(self, custom_fields=None, description=None, existing_account_number=None, new_account=None, order_date=None, order_number=None, processing_options=None, subscriptions=None):  # noqa: E501
