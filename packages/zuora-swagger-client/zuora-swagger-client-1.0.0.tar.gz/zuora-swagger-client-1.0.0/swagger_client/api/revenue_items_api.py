...
class RevenueItemsApi(object):
    ...
    def g_et_revenue_items_by_charge_revenue_event_number_with_http_info(self, event_number, **kwargs):  # noqa: E501
        ...
        if ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_revenue_items_by_charge_revenue_event_number`, length must be less than or equal to `64`")  # noqa: E501
    ...
    def g_et_revenue_items_by_charge_revenue_summary_number_with_http_info(self, crs_number, **kwargs):  # noqa: E501
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_revenue_items_by_charge_revenue_summary_number`, length must be less than or equal to `64`")  # noqa: E501
        if 'page_size' in params and params['page_size'] > 300:  # noqa: E501
    ...
    def g_et_revenue_items_by_revenue_schedule_with_http_info(self, rs_number, **kwargs):  # noqa: E501
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_revenue_items_by_revenue_schedule`, length must be less than or equal to `64`")  # noqa: E501
        if 'page_size' in params and params['page_size'] > 300:  # noqa: E501
    ...
    def p_ut_custom_fieldson_revenue_items_by_revenue_event_with_http_info(self, event_number, request, **kwargs):  # noqa: E501
        ...
        all_params = ['event_number', 'request', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_event`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_custom_fieldson_revenue_items_by_revenue_schedule_with_http_info(self, rs_number, request, **kwargs):  # noqa: E501
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_schedule`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
