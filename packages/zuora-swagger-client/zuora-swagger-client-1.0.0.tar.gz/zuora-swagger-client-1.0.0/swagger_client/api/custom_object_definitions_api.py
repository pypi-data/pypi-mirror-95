...
class CustomObjectDefinitionsApi(object):
    ...
    def delete_custom_object_definition_by_type(self, authorization, object, **kwargs):  # noqa: E501
        """Delete custom object definition  # noqa: E501

        Delete the custom object definition for the provided type.  **Note:** A custom object definition can only be deleted if no record of this custom object type exists.   # noqa: E501
    ...
    def g_et_all_custom_object_definitions_in_namespace(self, authorization, **kwargs):  # noqa: E501
        """Get all custom object definitions  # noqa: E501

        Get all custom objects definitions for a given tenant.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def g_et_custom_object_definition_by_type(self, authorization, object, **kwargs):  # noqa: E501
        """Get custom object definition  # noqa: E501

        Get the custom object definition by type for the given tenant.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def p_ost_custom_object_definition(self, authorization, custom_object_definition, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_custom_object_definition_with_http_info(authorization, custom_object_definition, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_custom_object_definition_with_http_info(authorization, custom_object_definition, **kwargs)  # noqa: E501
            return data

    def p_ost_custom_object_definition_with_http_info(self, authorization, custom_object_definition, **kwargs):  # noqa: E501
        """Create custom object definition  # noqa: E501

        Post a custom object definition with the request body schema below. This operation also supports that you use the [Get custom object definition](https://www.zuora.com/developer/api-reference/#operation/GET_CustomObjectDefinitionByType) response schema as its request schema.  The `label` field is the UI label of the custom object. The `object` field contains the API Name of the custom object.  ## Limitations   This custom object definition has the following limitations:  * The maximum number of characters for the Custom Object API Name (`object`) is 64. * The maximum number of characters for the Custom Object Label (`label`) is 64. * The maximum number of characters for the Custom Object Description 250. * The maximum number of custom fields in an custom object is 50. * The maximum number of characters for the custom field API name is 64. * The maximum number of characters for the custom field label (`label`) is 64. * The maximum number of characters for the custom field Description is 250. * The maximum number of picklist options is 250. * The default maximum number of characters for the Text field is 512. You can configure the max length up to 4,096 characters when creating or updating the custom object definition via API.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_custom_object_definition_with_http_info(authorization, custom_object_definition, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'custom_object_definition', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_custom_object_definition" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `p_ost_custom_object_definition`")  # noqa: E501
        # verify the required parameter 'custom_object_definition' is set
        if ('custom_object_definition' not in params or
                params['custom_object_definition'] is None):
            raise ValueError("Missing the required parameter `custom_object_definition` when calling `p_ost_custom_object_definition`")  # noqa: E501

        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_custom_object_definition`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'custom_object_definition' in params:
            body_params = params['custom_object_definition']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json; charset=utf-8'])  # noqa: E501
    ...
    def p_ost_update_custom_object_definition(self, authorization, migration, **kwargs):  # noqa: E501
        """Update custom object definition  # noqa: E501
    ...
    def p_ost_update_custom_object_definition_with_http_info(self, authorization, migration, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'migration', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
