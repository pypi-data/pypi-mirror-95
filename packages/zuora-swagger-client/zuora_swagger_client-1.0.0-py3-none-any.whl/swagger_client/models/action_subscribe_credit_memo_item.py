...
class ActionSubscribeCreditMemoItem(object):
    ...
    def __init__(self, amount_without_tax=None, charge_name=None, description=None, product_rate_plan_charge_id=None, quantity=None, service_end_date=None, service_start_date=None, tax_amount=None, unit_of_measure=None):  # noqa: E501
        """ActionSubscribeCreditMemoItem - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ActionSubscribeCreditMemoItem, dict):
