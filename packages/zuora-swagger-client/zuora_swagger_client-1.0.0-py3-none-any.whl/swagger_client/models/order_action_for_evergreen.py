...
class OrderActionForEvergreen(object):
    ...
    def __init__(self, add_product=None, cancel_subscription=None, create_subscription=None, custom_fields=None, id=None, order_metrics=None, owner_transfer=None, remove_product=None, resume=None, sequence=None, suspend=None, terms_and_conditions=None, trigger_dates=None, type=None, update_product=None):  # noqa: E501
