...
class CreatePaymentMethodBankTransferAccountHolderInfo(object):
    ...
    def __init__(self, account_holder_name=None, address_line1=None, address_line2=None, city=None, email=None, first_name=None, last_name=None, phone=None, state=None, zip_code=None):  # noqa: E501
