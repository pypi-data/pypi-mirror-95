...
class POSTOrderPreviewRequestType(object):
    ...
    def __init__(self, custom_fields=None, description=None, existing_account_number=None, order_date=None, order_number=None, preview_account_info=None, preview_options=None, subscriptions=None):  # noqa: E501
