...
class FeaturesApi(object):
    ...
    def object_post_feature(self, create_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.object_post_feature_with_http_info(create_request, **kwargs)  # noqa: E501
            return data
    ...
    def object_post_feature_with_http_info(self, create_request, **kwargs):  # noqa: E501
        ...
        if ('create_request' not in params or
            ...
            raise ValueError("Missing the required parameter `create_request` when calling `object_post_feature`")  # noqa: E501

        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_post_feature`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_put_feature(self, id, modify_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.object_put_feature_with_http_info(id, modify_request, **kwargs)  # noqa: E501
            return data
    ...
    def object_put_feature_with_http_info(self, id, modify_request, **kwargs):  # noqa: E501
        ...
        if ('modify_request' not in params or
            ...
            raise ValueError("Missing the required parameter `modify_request` when calling `object_put_feature`")  # noqa: E501

        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_put_feature`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
