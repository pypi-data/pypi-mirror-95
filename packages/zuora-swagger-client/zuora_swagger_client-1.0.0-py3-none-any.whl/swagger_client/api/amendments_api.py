...
class AmendmentsApi(object):
    ...
    def g_et_amendments_by_key_with_http_info(self, amendment_key, **kwargs):  # noqa: E501
        ...
        if ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_amendments_by_key`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_amendments_by_subscription_id_with_http_info(self, subscription_id, **kwargs):  # noqa: E501
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_amendments_by_subscription_id`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
