...
class PaymentMethodsApi(object):
    ...
    def g_et_payment_method(self, payment_method_id, **kwargs):  # noqa: E501
        ...
        This operation allows you to get the detailed information about a payment method.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def g_et_payment_method_with_http_info(self, payment_method_id, **kwargs):  # noqa: E501
        ...
        all_params = ['payment_method_id', 'zuora_track_id', 'zuora_entity_ids', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'page_size' in params and params['page_size'] > 40:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `g_et_payment_method`, must be a value less than or equal to `40`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_payment_methods_credit_card(self, account_key, **kwargs):  # noqa: E501
        ...
        This REST API reference describes how to retrieve all credit card information for the specified customer account.   ## Notes The response includes details of credit or debit cards for the specified customer account. Card numbers are masked, e.g., \"************1234\". Cards are returned in reverse chronological order of last update.  You can send requests for bank transfer or ACH type payment methods. However, the response will not include effective details of these payment methods.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def g_et_payment_methods_credit_card_with_http_info(self, account_key, **kwargs):  # noqa: E501
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_payment_methods_credit_card`, length must be less than or equal to `64`")  # noqa: E501
        if 'page_size' in params and params['page_size'] > 40:  # noqa: E501
    ...
    def object_post_payment_method_with_http_info(self, create_request, **kwargs):  # noqa: E501
        ...
        all_params = ['create_request', 'reject_unknown_fields', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def object_put_payment_method_with_http_info(self, id, modify_request, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'modify_request', 'reject_unknown_fields', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ost_cancel_authorization_with_http_info(self, payment_method_id, request, **kwargs):  # noqa: E501
        ...
        **Note:** If you wish to enable this feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Allows you to cancel an authorization. The payment gateways that support this operation include Verifi, CyberSource 1.28, CyberSource 1.97, Chase Paymentech Orbital, and Ingenico ePayments.   # noqa: E501
        ...
        all_params = ['payment_method_id', 'request', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_cancel_authorization`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_create_authorization_with_http_info(self, payment_method_id, request, **kwargs):  # noqa: E501
        ...
        **Note:** If you wish to enable this feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Enables you to authorize the availability of funds for a transaction but delay the capture of funds until a later time. Subsequently, use [CRUD: Create payment](https://www.zuora.com/developer/api-reference/#operation/Object_POSTPayment) or [Create payment](https://www.zuora.com/developer/api-reference/#operation/POST_CreatePayment) to capture the authorized funds, or use [Cancel authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CancelAuthorization) to cancel the authorization.   The payment gateways that support this operation include Verifi, CyberSource 1.28, CyberSource 1.97, Chase Paymentech Orbital, and Ingenico ePayments.  If you have the Invoice Settlement feature enabled, use the [Create payment](https://www.zuora.com/developer/api-reference/#operation/POST_CreatePayment) operation to capture the funds instead of the [CRUD: Create payment](https://www.zuora.com/developer/api-reference/#operation/Object_POSTPayment) operation.          # noqa: E501
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_create_authorization`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_payment_methods_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        all_params = ['request', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ost_payment_methods_credit_card_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_payment_methods_credit_card`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_payment_methods_credit_card_with_http_info(self, payment_method_id, request, **kwargs):  # noqa: E501
        ...
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_payment_methods_credit_card`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_verify_payment_methods_with_http_info(self, payment_method_id, body, **kwargs):  # noqa: E501
        ...
        all_params = ['payment_method_id', 'body', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
