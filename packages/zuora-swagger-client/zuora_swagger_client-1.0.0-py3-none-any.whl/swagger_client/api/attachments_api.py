...
class AttachmentsApi(object):
    ...
    def g_et_attachments_list(self, object_type, object_key, **kwargs):  # noqa: E501
        ...
        Use the View Attachment REST request to get a list of attachments on an account, an invoice, a subscription, a credit memo, or a debit memo.  **Note**: Credit memos or debit memos are available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in Limited Availability. If you want to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def p_ost_attachments_with_http_info(self, associated_object_type, associated_object_key, file, **kwargs):  # noqa: E501
        ...
        all_params = ['associated_object_type', 'associated_object_key', 'file', 'zuora_track_id', 'zuora_entity_ids', 'description']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ut_attachments_with_http_info(self, attachment_id, **kwargs):  # noqa: E501
        ...
        all_params = ['attachment_id', 'zuora_track_id', 'zuora_entity_ids', 'request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
