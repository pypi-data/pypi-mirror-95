...
class WorkflowsApi(object):
    ...
    def d_elete_workflow(self, authorization, workflow_id, **kwargs):  # noqa: E501
        """Delete a workflow by ID  # noqa: E501

        Deletes a specific workflow by its ID.   # noqa: E501
    ...
    def g_et_workflow(self, authorization, workflow_id, **kwargs):  # noqa: E501
        """Get a workflow by ID  # noqa: E501

        Retrieves information about a specific workflow by its ID.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def g_et_workflow_export(self, workflow_id, **kwargs):  # noqa: E501
        """Export a workflow  # noqa: E501

        Export a Workflow in a JSON document. This document can be used to create a copy of this workflow.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def g_et_workflows(self, authorization, **kwargs):  # noqa: E501
        ...
        Retrieves a list of workflows available in your Zuora tenant.         # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param int page_length: The number of workflows shown in a single call. If the `page` parameter is not specified, the operation will return only the first page of results. If there are multiple pages of results, use it with the `page` parameter to get the results on subsequent pages. 
    ...
    def g_et_workflows_task(self, authorization, task_id, **kwargs):  # noqa: E501
        ...
        Retrieves a specific workflow task by its ID.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def g_et_workflows_tasks(self, authorization, **kwargs):  # noqa: E501
        ...
        Retrieves a list of workflow tasks available in your Zuora tenant.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def g_et_workflows_usages(self, authorization, start_date, end_date, metrics, **kwargs):  # noqa: E501
        """Get workflow task usage  # noqa: E501

        Gets workflow task usage sorted by day within a specified time frame.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def p_ost_run_workflow(self, authorization, workflow_id, **kwargs):  # noqa: E501
        ...
        Run a specified workflow. In the request body, you can include parameters that you want to pass to the workflow. For the parameters to be recognized and picked up by tasks in the workflow, you need to define the parameters first.   To learn about how to define parameters, see [Configure the settings of a workflow](https://knowledgecenter.zuora.com/CE_Workflow/Using_Workflow/B_Configure_a_Workflow).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def p_ost_run_workflow_with_http_info(self, authorization, workflow_id, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'workflow_id', 'zuora_entity_ids', 'zuora_track_id', 'inputparameters']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ost_workflow_import(self, **kwargs):  # noqa: E501
        ...
        Creates a copy of a workflow using the exported JSON document of the original workflow.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def p_ost_workflow_import_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['zuora_track_id', 'request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ut_workflows_tasks_update(self, authorization, **kwargs):  # noqa: E501
        """Update tasks in batch  # noqa: E501

        Updates a group of workflow tasks.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def p_ut_workflows_tasks_update_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'zuora_entity_ids', 'zuora_track_id', 'update_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
