...
from cognite.air._utils import retrieve_field_definitions, retrieve_model_name, retrieve_model_version
...
class AIRClient:
    def __init__(self, data: Dict[str, Any], client: CogniteClient, secrets: Dict[str, Any], debug: bool = False):
        ...
        self._testing = is_string_truthy(data.get(LOCAL_TEST))
        ...
        if not self._testing:
            ...
            self._config = AIRClientConfig(
                ...
                schedule_asset_id=123,
                schedule_asset_ext_id="ScheduleAssetTestExtId",
                data_fields=data,
