...
if [ $1 == "test" ]; then
  ...
  lstfic=../src/pypos3d.ooo/PyPos3D-App-Installer.ods ../src/pypos3d.ooo/PyPos3DLO.ods ../src/pypos3d.ooo/PyPos3DLO-Example.ods ../CHANGELOG.md ../README.md ../LICENSE ../pypos3dapp.py ../pypos3dappext.py ../pypos3dinstaller.py
  ...
  #cp ../src/pypos3d.ooo/PyPos3DLO.ods PyPos3DLO/
  #cp ../src/pypos3d.ooo/PyPos3DLO-Example.ods PyPos3DLO/
  #cp ../CHANGELOG.md ../README.md ../LICENSE PyPos3DLO/
  (cd ../pypos3dtu ; zip -r ../dist/PyPos3DLO/examples.zip srcdata/)
