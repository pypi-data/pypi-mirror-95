...
class EndpointManager:
    ...
    def parse_endpoints(self, endpoints: List[dict]) -> Tuple[str, EndpointParseResponse]:
        for endpoint in endpoints:
            c_id, validator = self.parse(endpoint)

            if not isinstance(validator, AbstractEndpointValidator):
                return c_id, validator
