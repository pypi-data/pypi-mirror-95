...
class Skeleton:
    ...
    def to_drawable_skeleton(self) -> DrawableSkeleton:
        ...
        drawable_skeleton: DrawableSkeleton = DrawableSkeleton(joint_points, joint_lines, joint_names)
        return drawable_skeleton
...
class SkeletonVisualizer:
    ...
    def __create_skeleton_plot(self, skeletons: np.ndarray, colors: List[Color]) -> SkeletonPlot:
        ...
        for skeleton in map(
            ...
            skeleton_plot += skeleton.to_drawable_skeleton()
