...
import k3d
import numpy as np
from k3d.objects import Group, Line, Points, Label, Drawable
...
class DrawableSkeleton(Group):
    def __init__(self, joint_points: Points, joint_lines: List[Line], joint_names: List[Label]):
        ...
        self.joint_names: List[Label] = joint_names
...
class Skeleton:
    ...
    def to_drawable_skeleton(self) -> DrawableSkeleton:
        ...
        joint_names: List[Label] = self.get_joint_names()
    ...
    def get_joint_names(self) -> List[Label]:
        return [k3d.label(
