...
class SkeletonVisualizer:
    ...
    def visualize(self, skeletons: np.ndarray, colors: List[Color] = None):
        ...
        joint_name_visibility_button = widgets.Button(description="Hide joint names")
        joint_name_visibility_button.on_click(callback=self.__change_joint_name_visibility)
        display(joint_name_visibility_button)
        self.plot.display()
    ...
    def __change_joint_name_visibility(self):
        if self.joint_names_visible:
            for skeleton in self.skeletons:
                skeleton.hide_joint_names()
            self.joint_names_visible = False
        else:
            for skeleton in self.skeletons:
