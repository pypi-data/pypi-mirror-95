...
if __name__ == "__main__":
        ...
        def get_user_input():
            ...
            try:
                ...
                if preview:
                    ...
                    ten_seconds = preview_looper.seconds_to_frames(10) 
                    preview_offset = loop_end - ten_seconds if loop_end - ten_seconds > 0 else 0
    ...
    if args.play and not (args.export or args.json):
        try:
            ...
            loop_end, loop_start, score = choose_loop_pair(loop_pair_list, args.path)
