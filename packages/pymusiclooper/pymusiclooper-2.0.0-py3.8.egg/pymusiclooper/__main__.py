...
if __name__ == "__main__":
    ...
    def interactive_handler(loop_pair_list, file_path, n=20):
        preview_looper = MusicLooper(file_path, args.min_duration_multiplier)
        print("Discovered loop points:")
        for idx, pair in enumerate(loop_pair_list[:n]):
        ...
        def get_user_input():
            ...
            try:
                ...
                if preview:
                    print(f"Previewing loop pair {idx} (press Ctrl+C to stop looping)")
