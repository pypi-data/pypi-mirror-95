...
def remove_trailing_tabs(text: str) -> str:
    ...
    .. warning::
        ...
        Deprecated; use :func:`doctestprinter.strip_trailing_tabs` instead.
    ...
    warnings.warn(
        ...
        "Use `remove_trailing_tabs` instead.",
        DeprecationWarning,
    )
    return strip_trailing_tabs(text=text)
...
def remove_trailing_whitespaces(text: str) -> str:
    ...
    .. warning::
        ...
        Deprecated; use :func:`doctestprinter.strip_trailing_whitespaces` instead.
    ...
    warnings.warn(
        "This method will be removed in the next release. "
        "Use `strip_trailing_whitespaces` instead.",
        DeprecationWarning,
    )
    return strip_trailing_whitespaces(text=text)
...
def remove_trailing_whitespaces_and_tabs(text: str) -> str:
    ...
    .. warning::
        ...
        Deprecated; use :func:`doctestprinter.strip_trailing_whitespaces_and_tabs`
        instead.
    ...
    warnings.warn(
        "This method will be removed in the next release. "
        "Use `strip_trailing_whitespaces_and_tabs` instead.",
        DeprecationWarning,
    )
    return strip_trailing_whitespaces_and_tabs(text=text)
