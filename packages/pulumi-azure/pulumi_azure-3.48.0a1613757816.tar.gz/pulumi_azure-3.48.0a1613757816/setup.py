...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.48.0-alpha.1613757816+0fff4f72'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.48.0-alpha.1613757816+0fff4f72`
                """)
            else:
                raise
