...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.47.0-alpha.1613491271+b2eb7692'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.47.0-alpha.1613491271+b2eb7692`
                """)
            else:
                raise
