...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.48.0-alpha.1613570924+92a1e10e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.48.0-alpha.1613570924+92a1e10e`
                """)
            else:
                raise
