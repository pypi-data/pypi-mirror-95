...
class LabelingScheme:
    ...
    def get_constraints(self, node: Node, z3i: Z3Instance):
        """
...
class ThresholdClassicalOld(LabelingScheme):
    ...
    Requires two thresholds t_in and t_min_attack_out. A node is labeled
     ...
     Uses old implementation of get_constraints which does not necessarily produce unique labelings, though might be
