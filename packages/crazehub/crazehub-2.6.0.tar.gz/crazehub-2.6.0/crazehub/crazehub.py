...
if not os.path.exists("whitelist.txt"):
  ...
  pass
whitelistreadable = open("whitelist.txt", 'r')
...
if not IPAddr in whitelistreadable.read().splitlines(): 
 import urllib.request
 ...
 if token_input in correct_tokens:
   whitelistwritable = open("whitelist.txt", "a")
   whitelistwritable.write(IPAddr)
   whitelistwritable.write('\n')
 else:
   print("")
