...
if not IPAddr in whitelist.read().splitlines(): 
 import urllib.request
 ...
 print("Your IP Address is not authorized (or you deleted the text file containing your encrypted ip/delete your encrypted ip from it)")
