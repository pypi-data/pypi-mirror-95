...
class StandardObject(GridGainDataType, Nullable):
    _type_name = None
    _type_id = None
    type_code = None
...
class String(GridGainDataType, Nullable):
    """
...
class DecimalObject(GridGainDataType, Nullable):
...
class StandardArray(GridGainDataType, Nullable):
    """
