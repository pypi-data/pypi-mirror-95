...
class SQLStoragePlugin(pyzenkit.baseapp.ZenAppPlugin):
    ...
    def setup(self, application):
        ...
        :param application: Reference to the parent application.
        """
        mentat.services.sqlstorage.init(application.config)
        application.logger.debug("[STATUS] Set up connection to SQL storage.")
        application.sqlservice = mentat.services.sqlstorage.service()
        application.logger.debug("[STATUS] Set up SQL storage service.")
