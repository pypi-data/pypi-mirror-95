...
class SimpleTimelineSearchForm(flask_wtf.FlaskForm):
    ...
    def is_multivalue(field_name):
        ...
        :rtype: bool
        """
        if field_name in ('source_addrs', 'target_addrs', 'host_addrs', 'source_ports', 'target_ports', 'host_ports', 'source_types', 'target_types', 'host_types', 'detectors', 'detector_types', 'categories', 'severities', 'classess', 'protocols', 'groups', 'inspection_errs', 'aggregations'):
            return True
        return False
