...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.9.0-alpha.1613501710+4e432ed7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.9.0-alpha.1613501710+4e432ed7`
                """)
            else:
                raise
