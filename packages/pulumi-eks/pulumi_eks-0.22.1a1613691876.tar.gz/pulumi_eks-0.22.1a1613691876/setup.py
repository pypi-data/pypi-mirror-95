...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.22.1-alpha.1613691876+40c47e45'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.22.1-alpha.1613691876+40c47e45`
                """)
            else:
                raise
