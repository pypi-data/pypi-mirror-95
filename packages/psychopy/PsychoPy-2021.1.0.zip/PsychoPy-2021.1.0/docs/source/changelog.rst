...
.. warning::
  ...
  We **strongly recommend** that, once your experiment is being run, "for real" that you apply the :ref:`useVersion` 
  setting so that your study will always try to run on the sames PsychoPy version even where a different version
...
On top of those fixes are a number of useful additions though, like the new :ref:`buttonComponent`. particularlay
...
- :noncompat:`CHANGED: the new more-flexible parameters of PsychoPy Experiment Components makes experiments from 2021.1 **will not run**`
