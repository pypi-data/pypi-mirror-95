...
class Database():
    def __init__(self, name, waiters, executors, engine=None, operational_error=None,load_balancer=None):
        self.name = name
        ...
        self.r_query_succeeded_value=False
    ...
    def run_queries(self):
        while self.has_queries.acquire():
            ...
            self.waiters[query.wait].executor = self.executors
