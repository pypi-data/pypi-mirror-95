...
class Cemotion:
    def __init__(self):
        ...
        #检测所需文件是否存在，判断是否下载
        download_from_url('https://www.cyberlight.xyz/static/file/cemotion/big_Chinese_Words_Map.dict', dictionary_path)
        download_from_url('https://www.cyberlight.xyz/static/file/cemotion/rnn_emotion_1.0.h5', model_path)
        #加载rnn模型
