...
async def replaces(info):
	...
	while "$userAvatar[" in reline:
		if nowloop==reline:
			...
			prereline=in_replaces([reline.split("$userAvatar[")[-1].split("]")[0], need, members, content, info, resplit, allow])
			nowloop=reline
			try:
	...
	while "$getVar[" in reline:
		if nowloop==reline:
			...
			prereline=in_replaces([reline.split("$getVar[")[-1].split("]")[0], need, members, content, info, resplit, allow])
			nowloop=reline
	...
	while "$getServerVar[" in reline:
		if nowloop==reline:
			...
			prereline=in_replaces([reline.split("$getServerVar[")[-1].split("]")[0], need, members, content, info, resplit, allow])
			nowloop=reline
	...
	while "$getChannelVar[" in reline:
		if nowloop==reline:
			...
			prereline=in_replaces([reline.split("$getChannelVar[")[-1].split("]")[0], need, members, content, info, resplit, allow])
			nowloop=reline
	...
	while "$getUserVar[" in reline:
		if nowloop==reline:
			...
			prereline=in_replaces([reline.split("$getUserVar[")[-1].split("]")[0], need, members, content, info, resplit, allow])
			nowloop=reline
	...
	while "$leaderboard[" in reline:
		if nowloop==reline:
			...
			prereline=in_replaces([reline.split("$leaderboard[")[-1].split("]")[0], need, members, content, info, resplit, allow])
			nowloop=reline
			try:
