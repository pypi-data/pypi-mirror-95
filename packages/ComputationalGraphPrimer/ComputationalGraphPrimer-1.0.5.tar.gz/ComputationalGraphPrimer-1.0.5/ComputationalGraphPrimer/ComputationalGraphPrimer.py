...
__date__      = '2021-February-14'   
__url__       = 'https://engineering.purdue.edu/kak/distCGP/ComputationalGraphPrimer-1.0.5.html'
...
CHANGE LOG:
  ...
  Version 1.0.5:
    ...
    any nonlinearities in such networks, there was obviously be no real
...
INTRODUCTION:
    ...
    The FIRST GOAL of this Primer is to shed light on what is meant by a
    DAG in general. The acronym DAG stands for Directed Acyclic Graph. Just
    for the educational value of playing with data flows in DAGs, this
    module allows you to create a DAG of variables with a statement like
    ...
    You can call 'display_network2()' on an instance of
    ...
    be:
     ...
     derivatives for the Sigmoid nonlinearity. The backpropgation step
        ...
        if args:
            raise ValueError(  
                   '''ComputationalGraphPrimer constructor can only be called with keyword arguments for 
                      ...
                      batch_size, num_layers, layers_config, and debug''')
        expressions = output_vars = dataset_size = grad_delta = display_loss_how_often = learning_rate = one_neuron_model = training_iterations = batch_size = num_layers = layers_config = debug  = None
