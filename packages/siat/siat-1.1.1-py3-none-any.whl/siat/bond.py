...
def get_chinabond_index_list():
    ...
    headers = {
        'Referer': 'http://yield.chinabond.cn/',
        'User-Agent': UA,
    }

    url = 'http://yield.chinabond.cn/cbweb-mn/indices/queryTree'
    params = {
        'locale': 'zh_CN',
    }
    ...
    try:
        ...
        print("  Error(get_chinabond_index_list): data source unreachable.")
        return None
...
if __name__=='__main__':
    ...
    indexlistdf=pd.DataFrame(indexlist)
#==============================================================================
if __name__=='__main__':
    keystr='国债'
...
def get_chinabond_index(indexid):
    ...
    url = 'http://yield.chinabond.cn/cbweb-mn/indices/singleIndexQuery'
    params = {
        'indexid': indexid,
        'zslxt': 'CFZS',
        'qxlxt': '0,1,2,3,4,5,6',
