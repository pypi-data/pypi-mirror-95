...
CHANGE_COLUMN_DISPLAY_NAME = 'Changed a Column\'s Type'
...
def describe_change_column_type(
        widget_state_container,
        step,
        sheet_index, 
        column_header,
    ...
    df_name = step['df_names'][sheet_index]    
    return f'Changed {column_header} in {df_name} from {old_column_type} to {new_column_type}'


CHANGE_COLUMN_TYPE_STEP = {
    'step_version': 1,
    'step_display_name': CHANGE_COLUMN_DISPLAY_NAME,
    ...
    'describe': describe_change_column_type
}