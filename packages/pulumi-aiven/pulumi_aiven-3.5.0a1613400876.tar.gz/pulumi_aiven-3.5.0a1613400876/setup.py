...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.5.0-alpha.1613400876+ce4cf3b3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.5.0-alpha.1613400876+ce4cf3b3`
                """)
            else:
                raise
