...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.5.0-alpha.1613506808+5c3c819c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.5.0-alpha.1613506808+5c3c819c`
                """)
            else:
                raise
