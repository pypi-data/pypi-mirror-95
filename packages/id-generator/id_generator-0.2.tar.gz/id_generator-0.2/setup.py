...
setup(
  name = 'id_generator',         # How you named your package folder (MyLib)
  packages = ['id_generator'],   # Chose the same as "name"
  version = '0.2',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'An unique ID generator that writes to excel file (.xlsx)',   # Give a short description about your library
