...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '0.7.1-alpha.1613486591+0a701f7f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 0.7.1-alpha.1613486591+0a701f7f`
                """)
            else:
                raise
