...
class BundlingOutput(enum.Enum):
    ...
    '''(experimental) If the bundling output directory contains a single archive file (zip or jar) it will not be zipped.

    Otherwise the bundling output will be zipped.
