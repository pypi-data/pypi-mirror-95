...
[boto3.CostandUsageReportService 1.17.9](https://boto3.amazonaws.com/v1/documentation/api/1.17.9/reference/services/cur.html#CostandUsageReportService) service
compatible with
