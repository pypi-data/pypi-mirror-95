...
class RestClient:
    ...
    def post(self, uri, json_data=None, timeout=None, dst=None, **kwargs):
        if timeout is None:
            timeout = self.timeout
        ...
        data = None
        if json_data:
            data = json_data.json() if json_data.__class__ == ModelMetaclass else json.dumps(json_data)
    ...
    def put(self, uri, json_data=None, timeout=None, dst=None, **kwargs):
        if timeout is None:
            timeout = self.timeout
    ...
    def delete(self, uri, timeout=None, dst=None, **kwargs):
        if timeout is None:
            timeout = self.timeout
