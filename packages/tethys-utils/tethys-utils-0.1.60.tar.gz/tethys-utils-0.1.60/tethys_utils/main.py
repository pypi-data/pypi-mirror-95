...
def update_results_s3(data_dict, conn_config, bucket, threads=20, add_old=False, read_buffer=False, last_run_date_key=None):
    """
    ...
    for ds_id, results in data_dict.items():
        ...
        def update_result(result):
            ...
            up1 = compare_datasets_from_s3(s3, bucket, new1, add_old=add_old, read_buffer=read_buffer, last_run_date_key=last_run_date_key)
