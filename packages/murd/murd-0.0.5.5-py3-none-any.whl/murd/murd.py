...
class Murd(M_management, Murd_json_file):
    ...
    def read(
        ...
        if murd is None or is_iterable(murd):
            ...
            return self.murds[murd].read(group, sort, min_sort, max_sort,
                                         limit, ascending_order, murd)

        return self.read_data(group, sort, min_sort,
                              max_sort, limit, ascending_order)
