...
[boto3.ForecastQueryService 1.17.9](https://boto3.amazonaws.com/v1/documentation/api/1.17.9/reference/services/forecastquery.html#ForecastQueryService) service
compatible with
