...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'splunk', '0.2.1-alpha.1613484805+05f765f3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource splunk 0.2.1-alpha.1613484805+05f765f3`
                """)
            else:
                raise
