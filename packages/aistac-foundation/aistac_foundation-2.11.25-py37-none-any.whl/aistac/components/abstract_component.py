...
class AbstractComponent(ABC):
    ...
    def set_report_persist(self, reports: [str, list]=None, save: bool=None, **kwargs):
        ...
        :param save: (optional) if True, save to file. Default is True
        """
        if reports is not None and not isinstance(reports, (str, list)):
        ...
        if isinstance(reports, (str, list)):
            _reports = self.pm.list_formatter(reports)
