...
class _Logger:
	...
	def __init__(self,
							 ...
							 step  		  : bool,
							 self_debug : bool):
		self._mail_client, self._mail_level = mail_client
	...
	def debug(self, message, mail_level = 6, step = False):
		...
		if mail_level >= self._mail_level and self._mail_client:
...
def initLogger(name, lvl = INFO, mail = None, colorize = False, step = False, self_debug = False):
	global _logger
	_logger = _Logger(name, lvl, mail, colorize, step, self_debug)
...
def initOrGetLogger(name = "", lvl = INFO, mail = None, colorize = False, step = False, self_debug = False):
	global _logger
	if _logger == None:
