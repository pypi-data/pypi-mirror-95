...
def create_function(
    ...
    function = client.functions.create( 
        ...
        owner=owner,
        secrets=secrets,
        env_vars=config.getenv.__dict__
    )
    logging.debug(
        f"Created {function_name}: {folder=}, {handler_path=}"
    )
...
def deploy_function(
    ...
    secrets=api_keys.pop("__initialised__"),
