...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.17.0-alpha.1613647520+75f0d8d9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.17.0-alpha.1613647520+75f0d8d9`
                """)
            else:
                raise
