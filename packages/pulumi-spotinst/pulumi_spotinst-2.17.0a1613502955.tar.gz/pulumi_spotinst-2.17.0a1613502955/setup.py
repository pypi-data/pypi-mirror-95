...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.17.0-alpha.1613502955+e4a616e6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.17.0-alpha.1613502955+e4a616e6`
                """)
            else:
                raise
