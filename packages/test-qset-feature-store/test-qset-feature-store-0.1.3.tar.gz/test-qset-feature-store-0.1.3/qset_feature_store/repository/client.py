...
class QsetRepositoryClient:
    ...
    def create_featureset(self, name, engine, body=None, inputs=None, **kwargs):
        body = body or {}
        inputs = inputs or {}
        return cast_dict(models.FeatureSet(account=self.account, name=name, engine=engine, body=body, inputs=inputs, **kwargs), models.FeatureSet)
    ...
    def create_pandas_featureset(self, featureset_cls, inputs=None, name=None, **kwargs):
        ...
        return self.create_featureset(name=name,
                                      engine='pandas/v1',
                                      inputs=inputs,
                                      body={'code': get_featureset_code_from_current_notebook(featureset_cls)}, **kwargs)
