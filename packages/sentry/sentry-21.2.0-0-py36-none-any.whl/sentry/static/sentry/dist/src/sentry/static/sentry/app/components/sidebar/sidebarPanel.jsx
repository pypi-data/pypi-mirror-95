...
var PanelContainer = styled('div')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  position: fixed;\n  bottom: 0;\n  display: flex;\n  flex-direction: column;\n  z-index: ", ";\n  background: ", ";\n  color: ", ";\n  border-right: 1px solid ", ";\n  box-shadow: 1px 0 2px rgba(0, 0, 0, 0.06);\n  text-align: left;\n  line-height: 24px;\n  animation: 200ms ", ";\n\n  ", ";\n"], ["\n  position: fixed;\n  bottom: 0;\n  display: flex;\n  flex-direction: column;\n  z-index: ", ";\n  background: ", ";\n  color: ", ";\n  border-right: 1px solid ", ";\n  box-shadow: 1px 0 2px rgba(0, 0, 0, 0.06);\n  text-align: left;\n  line-height: 24px;\n  animation: 200ms ", ";\n\n  ", ";\n"])), function (p) { return p.theme.zIndex.sidebarPanel; }, function (p) { return p.theme.backgroundSecondary; }, function (p) { return p.theme.textColor; }, function (p) { return p.theme.border; }, slideInLeft, getPositionForOrientation);
