    ...
    return (<Route>
      ...
      <Route path="/" component={errorHandler(App)}>
        ...
        /* webpackChunkName: "ProjectAlertsCreate" */ 'app/views/settings/projectAlerts/create');
          ...
          <Route path="/organizations/:orgId/events/" componentPromise={function () {
        return import(/* webpackChunkName: "EventsContainer" */ 'app/views/events');
    }} component={errorHandler(LazyLoad)}>
            <IndexRoute componentPromise={function () {
        return import(/* webpackChunkName: "Events" */ 'app/views/events/events');
    }} component={errorHandler(LazyLoad)}/>
          </Route>
        ...
        /* webpackChunkName: "OrganizationActivity" */ 'app/views/organizationActivity');
          ...
          <Route path="/organizations/:orgId/discover/queries/" componentPromise={function () {
        ...
        /* webpackChunkName: "DiscoverV2Landing" */ 'app/views/eventsV2/landing');
          ...
          <Route path="/organizations/:orgId/discover/results/" componentPromise={function () {
        return import(/* webpackChunkName: "DiscoverV2Container" */ 'app/views/eventsV2');
    }} component={errorHandler(LazyLoad)}>
            <IndexRoute componentPromise={function () {
        return import(
        /* webpackChunkName: "DiscoverV2Results" */ 'app/views/eventsV2/results');
          ...
          <Route path="/organizations/:orgId/discover/:eventSlug/" componentPromise={function () {
        return import(/* webpackChunkName: "DiscoverV2Container" */ 'app/views/eventsV2');
    }} component={errorHandler(LazyLoad)}>
            <IndexRoute componentPromise={function () {
        return import(
        ...
        return import(/* webpackChunkName: "DiscoverContainer" */ 'app/views/discover');
    }} component={errorHandler(LazyLoad)}>
