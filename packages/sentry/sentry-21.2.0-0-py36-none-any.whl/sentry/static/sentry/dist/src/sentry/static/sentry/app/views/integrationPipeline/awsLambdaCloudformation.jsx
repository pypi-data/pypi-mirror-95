...
var AwsLambdaCloudformation = /** @class */ (function (_super) {
    ...
    function AwsLambdaCloudformation() {
        ...
        _this.render = function () {
            ...
            var _a = _this.state, accountNumber = _a.accountNumber, region = _a.region, accountNumberError = _a.accountNumberError, submitting = _a.submitting, awsExternalId = _a.awsExternalId;
        ...
        <StyledList symbol="colored-numeric" initialCounterValue={initialStepNumber}>
          <ListItem>
            <ExternalLink onClick={_this.trackOpenCloudFormation} href={_this.cloudformationUrl}>
