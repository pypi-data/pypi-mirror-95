...
var Chart = /** @class */ (function (_super) {
    ...
    Chart.prototype.render = function () {
        var _a;
        var _b = this.props, _loading = _b.loading, _reloading = _b.reloading, yAxis = _b.yAxis, releaseSeries = _b.releaseSeries, zoomRenderProps = _b.zoomRenderProps, timeseriesData = _b.timeseriesData, previousTimeseriesData = _b.previousTimeseriesData, showLegend = _b.showLegend, legendOptions = _b.legendOptions, chartOptionsProp = _b.chartOptions, currentSeriesName = _b.currentSeriesName, previousSeriesName = _b.previousSeriesName, seriesTransformer = _b.seriesTransformer, colors = _b.colors, props = __rest(_b, ["loading", "reloading", "yAxis", "releaseSeries", "zoomRenderProps", "timeseriesData", "previousTimeseriesData", "showLegend", "legendOptions", "chartOptions", "currentSeriesName", "previousSeriesName", "seriesTransformer", "colors"]);
        ...
        var legend = showLegend
            ? __assign({ right: 16, top: 12, data: data, selected: seriesSelection }, (legendOptions !== null && legendOptions !== void 0 ? legendOptions : {})) : undefined;
        ...
        var chartOptions = __assign({ colors: timeseriesData.length
                ? (_a = colors === null || colors === void 0 ? void 0 : colors.slice(0, series.length)) !== null && _a !== void 0 ? _a : __spread(theme.charts.getColorPalette(timeseriesData.length - 2)) : undefined, grid: {
                left: '24px',
                right: '24px',
                top: '32px',
                bottom: '12px',
