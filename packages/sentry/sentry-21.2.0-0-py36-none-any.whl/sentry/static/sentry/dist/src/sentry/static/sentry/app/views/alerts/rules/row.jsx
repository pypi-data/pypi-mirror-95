...
var RuleListRow = /** @class */ (function (_super) {
    ...
    RuleListRow.prototype.render = function () {
        var _a, _b;
        var _c = this.props, rule = _c.rule, projectsLoaded = _c.projectsLoaded, projects = _c.projects, organization = _c.organization, orgId = _c.orgId, onDelete = _c.onDelete;
        ...
        <RightColumn>
          <Access access={['alerts:write']}>
            ...
            return (<ButtonBar gap={1}>
                ...
                <Button size="small" icon={<IconSettings />} title={t('Edit')} to={editLink}/>
              </ButtonBar>);
        }}
          </Access>
        </RightColumn>
