...
var DropdownControl = /** @class */ (function (_super) {
    ...
    DropdownControl.prototype.render = function () {
        var _this = this;
        var _a = this.props, children = _a.children, alwaysRenderMenu = _a.alwaysRenderMenu, alignRight = _a.alignRight, menuWidth = _a.menuWidth, blendWithActor = _a.blendWithActor, priority = _a.priority, className = _a.className;
        ...
        <DropdownMenu alwaysRenderMenu={alwaysRenderMenu}>
          {function (_a) {
            ...
            return (<React.Fragment>
              ...
              <Content {...getMenuProps()} priority={priority} alignMenu={alignMenu} width={menuWidth} isOpen={isOpen} blendWithActor={blendWithActor} blendCorner>
                {children}
              </Content>
            </React.Fragment>);
        }}
