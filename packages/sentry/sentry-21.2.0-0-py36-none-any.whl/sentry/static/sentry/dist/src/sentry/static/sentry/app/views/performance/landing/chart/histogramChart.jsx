...
export function HistogramChart(props) {
    var location = props.location, onFilterChange = props.onFilterChange, organization = props.organization, eventView = props.eventView, field = props.field, title = props.title, titleTooltip = props.titleTooltip;
    var xAxis = {
        type: 'category',
        truncate: true,
        boundaryGap: false,
