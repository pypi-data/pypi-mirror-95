...
var WidgetQueries = /** @class */ (function (_super) {
    ...
    WidgetQueries.prototype.fetchEventData = function () {
        var _this = this;
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        this.setState(function (prevState) {
                            return __assign(__assign({}, prevState), { tableResults: tableResults, loading: completed === promises.length ? false : true });
                        });
                        return [3 /*break*/, 3];
                    case 2:
                        err_1 = _e.sent();
    ...
    WidgetQueries.prototype.fetchTimeseriesData = function () {
        var _this = this;
        var _a = this.props, selection = _a.selection, api = _a.api, organization = _a.organization, widget = _a.widget;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.setState(function (prevState) {
                            var _a;
                            var timeseriesResults = (_a = prevState.timeseriesResults) === null || _a === void 0 ? void 0 : _a.concat(transformResult(widget.queries[i], rawResults_1));
                            return __assign(__assign({}, prevState), { timeseriesResults: timeseriesResults, loading: completed === promises.length ? false : true });
                        });
                        return [3 /*break*/, 3];
                    case 2:
                        err_2 = _b.sent();
