    ...
    SmartSearchBar.prototype.render = function () {
        ...
        <StyledButtonBar gap={0.5}>
          ...
          {canCreateSavedSearch && (<ClassNames>
              {function (_a) {
            var css = _a.css;
            return (<CreateSavedSearchButton query={_this.state.query} organization={organization} withTooltip iconOnly buttonClassName={css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n                    ", "\n                  "], ["\n                    ",
                "\n                  "])), getInputButtonStyles({
                collapseIntoEllipsisMenu: 2,
            }))} tooltipClassName={css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n                    ", "\n                  "], ["\n                    ", "\n                  "])), getMediaQuery(theme.breakpoints[2], 'none'))}/>);
        }}
            </ClassNames>)}
          {hasSearchBuilder && (<ClassNames>
            ...
            return (<InputButton title={t('Toggle search builder')} borderless size="zero" tooltipProps={{
                containerDisplayMode: 'inline-flex',
                className: css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n                      ", "\n                    "], ["\n                      ", "\n                    "])), getMediaQuery(theme.breakpoints[2], 'none')),
          ...
          {(hasPinnedSearch || canCreateSavedSearch || hasSearchBuilder) && (<StyledDropdownLink anchorRight caret={false} title={<EllipsisButton size="zero" borderless tooltipProps={{
            containerDisplayMode: 'flex',
              ...
              {canCreateSavedSearch && (<ClassNames>
                  {function (_a) {
            var css = _a.css;
            return (<CreateSavedSearchButton query={_this.state.query} organization={organization} buttonClassName={css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n                        ", "\n                      "], ["\n                        ",
                "\n                      "])), getDropdownElementStyles({
                showBelowMediaQuery: 2,
                last: false,
            }))} tooltipClassName={css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n                        ", "\n                      "], ["\n                        ", "\n                      "])), getMediaQuery(theme.breakpoints[2], 'none'))}/>);
        }}
                </ClassNames>)}
