...
var QueryCount = function (_a) {
    var count = _a.count, max = _a.max, _b = _a.hideIfEmpty, hideIfEmpty = _b === void 0 ? true : _b, _c = _a.hideParens, hideParens = _c === void 0 ? false : _c, _d = _a.isTag, isTag = _d === void 0 ? false : _d;
