...
var Chart = /** @class */ (function (_super) {
    ...
    Chart.prototype.render = function () {
        var _a = this.props, data = _a.data, router = _a.router, statsPeriod = _a.statsPeriod, start = _a.start, end = _a.end, utc = _a.utc, loading = _a.loading, height = _a.height, grid = _a.grid, disableMultiAxis = _a.disableMultiAxis;
