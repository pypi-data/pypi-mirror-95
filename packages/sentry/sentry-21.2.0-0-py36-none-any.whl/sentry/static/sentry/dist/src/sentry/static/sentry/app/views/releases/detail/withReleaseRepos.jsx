    ...
    return withApi(withOrganization(withRepositories((_a = /** @class */ (function (_super) {
            ...
            class_1.prototype.render = function () {
                ...
                return (<WrappedComponent {...this.props} // this is just to satisfy the compiler
                 orgSlug={orgSlug} release={release} router={router} location={location} projectSlug={this.context.project.slug} releaseRepos={releaseRepos} activeReleaseRepo={activeReleaseRepo}/>);
            };
            return class_1;
        }(React.Component)),
