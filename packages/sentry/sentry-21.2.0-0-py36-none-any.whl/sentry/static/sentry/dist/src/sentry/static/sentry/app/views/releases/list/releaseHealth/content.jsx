      ...
      <ProjectRows>
        ...
        return (<ProjectRow key={releaseVersion + "-" + slug + "-health"}>
                <Layout>
                  ...
                  {activeDisplay === DisplayOption.CRASH_FREE_USERS ? (<SessionsColumn>
                  ...
                  <CrashesColumn>
                    {showPlaceholders ? (<StyledPlaceholder width="30px"/>) : hasHealthData && defined(sessionsCrashed) ? (<Tooltip title={t('Open in Issues')}>
                        <GlobalSelectionLink to={getReleaseUnhandledIssuesUrl(orgSlug, project.id, releaseVersion)}>
                  ...
                  <NewIssuesColumn>
                    <Tooltip title={t('Open in Issues')}>
                      <GlobalSelectionLink to={getReleaseNewIssuesUrl(orgSlug, project.id, releaseVersion)}>
                  ...
                  <ViewColumn>
                    <ProjectLink orgSlug={orgSlug} project={project} releaseVersion={releaseVersion} location={location}/>
                  </ViewColumn>
                </Layout>
              </ProjectRow>);
    })}
...
var SessionsColumn = styled(Column)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  @media (min-width: ", ") {\n    text-align: center;\n  }\n"], ["\n  @media (min-width: ", ") {\n    text-align: center;\n  }\n"])), function (p) { return p.theme.breakpoints[0]; });
var DailyColumn = styled(Column)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  display: none;\n\n  @media (min-width: ", ") {\n    display: flex;\n    /* Chart tooltips need overflow */\n    overflow: visible;\n  }\n"], ["\n  display: none;\n\n  @media (min-width: ", ") {\n    display: flex;\n    /* Chart tooltips need overflow */\n    overflow: visible;\n  }\n"])), function (p) { return p.theme.breakpoints[3]; });
...
var ProgressBarWrapper = styled('div')(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  min-width: 70px;\n  max-width: 90px;\n"], ["\n  min-width: 70px;\n  max-width: 90px;\n"])));
