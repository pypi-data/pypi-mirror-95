...
var WidgetCardChart = /** @class */ (function (_super) {
    ...
    WidgetCardChart.prototype.render = function () {
        var _this = this;
        var _a, _b, _c;
        var _d = this.props, tableResults = _d.tableResults, timeseriesResults = _d.timeseriesResults, errorMessage = _d.errorMessage, loading = _d.loading, widget = _d.widget;
