...
var EventDetailsContent = /** @class */ (function (_super) {
    ...
    EventDetailsContent.prototype.renderContent = function (event) {
        ...
        <Layout.Header>
          ...
          <Layout.HeaderActions>
            <ButtonBar gap={1}>
              ...
              {hasQuickTraceView && (<Button icon={<IconOpen />} href={eventJsonUrl} external>
        ...
        <Layout.Body>
          {hasQuickTraceView && (<Layout.Main fullWidth>
              <EventMetas event={event} organization={organization} projectId={this.projectId} location={location}/>
            </Layout.Main>)}
          ...
          {isSidebarVisible && (<Layout.Side>
              {!hasQuickTraceView && (<React.Fragment>
