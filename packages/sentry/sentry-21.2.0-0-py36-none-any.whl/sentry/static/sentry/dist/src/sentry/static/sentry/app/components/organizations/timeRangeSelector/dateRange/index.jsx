...
var DateRange = /** @class */ (function (_super) {
    ...
    function DateRange() {
        ...
        _this.handleChangeStart = function (e) {
            ...
            var _a = _this.props, start = _a.start, end = _a.end, onChange = _a.onChange;
    ...
    DateRange.prototype.render = function () {
        var _a = this.props, className = _a.className, maxPickableDays = _a.maxPickableDays, utc = _a.utc, start = _a.start, end = _a.end, showTimePicker = _a.showTimePicker, onChangeUtc = _a.onChangeUtc;
