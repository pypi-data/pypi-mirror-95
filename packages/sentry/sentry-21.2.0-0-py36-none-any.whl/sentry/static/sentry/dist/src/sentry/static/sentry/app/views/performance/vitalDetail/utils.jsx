...
export var vitalStateColors = (_c = {},
    _c[VitalState.POOR] = theme.red300,
    _c[VitalState.MEH] = theme.yellow300,
    _c[VitalState.GOOD] = theme.green300,
    _c);
export var vitalStateIcons = (_d = {},
    _d[VitalState.POOR] = IconFire,
    _d[VitalState.MEH] = IconWarning,
    _d[VitalState.GOOD] = IconCheckmark,
    _d);
