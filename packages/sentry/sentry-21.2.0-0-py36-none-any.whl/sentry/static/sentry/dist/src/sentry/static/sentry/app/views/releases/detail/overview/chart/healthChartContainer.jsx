    ...
    ReleaseChartContainer.prototype.render = function () {
        ...
        {function (zoomRenderProps) {
            ...
            return (<TransitionChart loading={loading} reloading={reloading}>
              ...
              <HealthChart timeseriesData={timeseriesData} zoomRenderProps={zoomRenderProps} reloading={reloading} yAxis={yAxis} location={router.location} shouldRecalculateVisibleSeries={shouldRecalculateVisibleSeries} onVisibleSeriesRecalculated={_this.handleVisibleSeriesRecalculated} platform={platform} title={title} help={help}/>
            </TransitionChart>);
        }}
      </ChartZoom>);
    };
