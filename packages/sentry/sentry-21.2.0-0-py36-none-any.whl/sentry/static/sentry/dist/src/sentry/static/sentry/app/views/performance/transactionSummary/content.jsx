...
var SummaryContent = /** @class */ (function (_super) {
    ...
    SummaryContent.prototype.render = function () {
        ...
        var _b = getTransactionsListSort(location, {
            p95: slowDuration,
        }), selectedSort = _b.selectedSort, sortOptions = _b.sortOptions;
        ...
        <Layout.Body>
          ...
          <Layout.Main>
            ...
            <TransactionsList location={location} organization={organization} eventView={eventView} selected={selectedSort} options={sortOptions} titles={[t('id'), t('user'), t('duration'), t('timestamp')]} handleDropdownChange={this.handleTransactionsListSortChange} generateLink={{
            id: generateTransactionLink(transactionName),
        }} baseline={transactionName} handleBaselineClick={this.handleViewDetailsClick} handleCellAction={this.handleCellAction} handleOpenInDiscoverClick={this.handleDiscoverViewClick}/>
          ...
          <Layout.Side>
            <UserStats organization={organization} location={location} totals={totalValues} transactionName={transactionName} eventView={eventView}/>
