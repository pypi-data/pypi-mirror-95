...
var Sidebar = /** @class */ (function (_super) {
    ...
    Sidebar.prototype.render = function () {
        ...
        var events = hasOrganization && discoverState.events && (<Feature features={['events']} hookName="feature-disabled:events-sidebar-item" organization={organization}>
        ...
        var discover1 = hasOrganization && discoverState.discover1 && (<Feature features={['discover']} hookName="feature-disabled:discover-sidebar-item" organization={organization}>
        ...
        var discover2 = hasOrganization && discoverState.discover2 && (<Feature hookName="feature-disabled:discover2-sidebar-item" features={['discover-basic']} organization={organization}>
        <SidebarItem {...sidebarItemProps} onClick={function (_id, evt) {
