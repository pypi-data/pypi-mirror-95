...
var TimeRangeSelector = /** @class */ (function (_super) {
    ...
    TimeRangeSelector.prototype.render = function () {
        ...
        var relativeSelected = isAbsoluteSelected ? null : relative || defaultPeriod;
        ...
        {function (_a) {
            ...
            {isOpen && (<Menu {...getMenuProps()} isAbsoluteSelected={isAbsoluteSelected}>
                ...
                {isAbsoluteSelected && (<div>
                    <DateRangeHook start={start} end={end} organization={organization} showTimePicker utc={_this.state.utc} onChange={_this.handleSelectDateRange} onChangeUtc={_this.handleUseUtc}/>
                    <SubmitRow>
