...
var FiltersAndSampling = /** @class */ (function (_super) {
    ...
    function FiltersAndSampling() {
        ...
        _this.successfullySubmitted = function (projectDetails) {
        ...
        _this.handleDeleteRule = function (rule) { return function () {
            ...
            var newErrorRules = rule.type === DynamicSamplingRuleType.ERROR
                ? errorRules.filter(function (errorRule) { return !isEqual(errorRule, rule); })
                : errorRules;
            var newTransactionRules = rule.type !== DynamicSamplingRuleType.ERROR
                ? transactionRules.filter(function (transactionRule) { return !isEqual(transactionRule, rule); })
                : transactionRules;
    ...
    FiltersAndSampling.prototype.renderBody = function () {
        ...
        <RulesPanel rules={errorRules} disabled={disabled} onAddRule={this.handleAddRule('errorRules')} onEditRule={this.handleEditRule} onDeleteRule={this.handleDeleteRule} onUpdateRules={this.handleUpdateRules}/>
        <TextBlock>
