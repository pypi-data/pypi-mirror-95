...
function RulesPanel(_a) {
    var rules = _a.rules, onAddRule = _a.onAddRule, onEditRule = _a.onEditRule, onDeleteRule = _a.onDeleteRule, disabled = _a.disabled, onUpdateRules = _a.onUpdateRules;
    return (<Panel>
      <Rules rules={rules} onEditRule={onEditRule} onDeleteRule={onDeleteRule} disabled={disabled} onUpdateRules={onUpdateRules}/>
      <StyledPanelFooter>
        <ButtonBar gap={1}>
