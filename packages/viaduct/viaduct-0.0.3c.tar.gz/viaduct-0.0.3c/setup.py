...
setup(
    ...
    version='0.0.3c',      # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/harrytwigg/Viaduct-Trading212-Python-API/archive/0.0.3c.tar.gz',
