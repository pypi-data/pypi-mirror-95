...
def run_apidoc(app):
    ...
    better_apidoc.main(
        [
            ...
            os.path.join(ROOT / 'src' / 'garm_rate_limiter'),
        ]
    )
...
nitpick_ignore = [
    ('py:class', 'callable'),
    ('py:class', 'werkzeug.exceptions.Forbidden'),
]
...
source_suffix = '.rst'
master_doc = 'index'
project = 'Garm Rate Limiter'
year = str(datetime.datetime.now().year)
author = 'Burak Özdemir'
copyright = '{0}, {1}'.format(year, author)
version = garm_rate_limiter.__version__
release = version
git_tag = "v%s" % version
...
extlinks = {
    'issue': ('https://github.com/burakozdemir32/garm_rate_limiter/issues/%s', '#'),
    'pr': ('https://github.com/burakozdemir32/garm_rate_limiter/pull/%s', 'PR #'),
}
...
.. only:: html
    ...
    :raw-html:`<a href="http://nbviewer.jupyter.org/github/burakozdemir32/garm_rate_limiter/blob/<<GIT_TAG>>/{{ docname }}" target="_blank"><img alt="Render on nbviewer" src="https://img.shields.io/badge/render%20on-nbviewer-orange.svg" style="vertical-align:text-bottom"></a>&nbsp;<a href="https://mybinder.org/v2/gh/burakozdemir32/garm_rate_limiter/<<GIT_TAG>>?filepath={{ docname }}}" target="_blank"><img alt="Launch Binder" src="https://mybinder.org/badge_logo.svg" style="vertical-align:text-bottom"></a>`
""".replace(
    '<<GIT_TAG>>', git_tag
)
