	...
	def create(self):
		...
		if OS in ["linux"]:
			...
			if output == "":
				...
				return r3sponse.error(String(output.replace("useradd: ", "").replace("\n", ". ")).capitalized_word())
	...
	def create(self, users=None):
		...
		if OS in ["linux"]:
			...
			if output == "":
				...
				return r3sponse.error(String(output.replace("groupadd: ", "").replace("\n", ". ")).capitalized_word())
	...
	def delete_users(self, users=[]):
		...
		if OS in ["linux"]:
			for user in users:
				...
				if output != "":
					return r3sponse.error(String(output.replace("deluser: ", "").replace("\n", ". ")).capitalized_word())
	...
	def add_users(self, users=[]):
		...
		if OS in ["linux"]:
			for user in users:
				...
				if str(output) != "":
					return r3sponse.error(String(output.replace("usermod: ", "").replace("\n", ". ")).capitalized_word())
