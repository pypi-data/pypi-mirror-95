...
from oog import env_wrappers
from oog import observers
from oog import environment
from oog_demos import gif_writer as gif_writer_lib
from oog_demos import human_agent

FLAGS = flags.FLAGS
flags.DEFINE_string('config',
                    'oog_demos.example_configs.pong',
