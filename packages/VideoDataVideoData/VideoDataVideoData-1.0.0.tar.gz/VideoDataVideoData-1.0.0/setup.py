...
setuptools.setup(
    name="VideoDataVideoData",  # 包的分发名称，使用字母、数字、_、-
    version="1.0.0",  # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="jasonchow",  # 作者名字
    author_email="125693535@qq.com",  # 作者邮箱
    description="Get VideoData",  # 包的简介描述
    long_description='Get VideoData',  # 包的详细介绍(一般通过加载README.md)
