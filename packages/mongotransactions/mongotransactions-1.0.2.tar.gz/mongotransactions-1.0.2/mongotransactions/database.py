...
class Database:
    ...
    Wrapper class around pyMongo::
        database = Database('mongodb+srv://username:passsword@host/)

    class will set the database to the first one it has access to but you can
    change this with set_database function

    when a database is set the class will also update .collections which will
    ...
    def __set_collections(self) -> None:
