...
def caller(index: int = 2, _vars: bool = True, _glob: bool = False, _loc: bool = False) -> Caller:
    ...
    def exclude(d):
        ...
        if any([inspect.getmodule(Callable) == typing, inspect.ismodule(d), inspect.isroutine(d),
                isinstance(d, (property, )), inspect.isclass(d), isinstance(d, Caller), isinstance(d, CallerVars)]):
            return True
...
bapy = Package(filename=__file__, _version='0.22.8')
