	...
	class Array(object):
		def __init__(self, 
			...
			if isinstance(array, Files.Array):
				...
				raise exceptions.InstanceError(f"Parameter [{self.__name__}.array] must be a [Array] or [list], not [{array.__name__}].")
	...
	class Dictionary(object):
		def __init__(self, 
			...
			if isinstance(dictionary, Files.Dictionary):
				...
				raise exceptions.InstanceError(f"Parameter [{self.__name__}.dictionary] must be a [Dictionary] or [dict], not [{dictionary.__name__}].")
