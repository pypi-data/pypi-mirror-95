	...
	class Array(object):
		def __init__(self, 
			...
			if isinstance(array, Files.Array):
				...
				raise exceptions.InstanceError(f"Parameter [{self.__class__}.array] must be a [Array] or [list], not [{dictionary.__class__}].")
	...
	class Dictionary(object):
		def __init__(self, 
			...
			if isinstance(dictionary, Files.Dictionary):
				...
				raise exceptions.InstanceError(f"Parameter [{self.__class__}.dictionary] must be a [Dictionary] or [dict], not [{dictionary.__class__}].")
