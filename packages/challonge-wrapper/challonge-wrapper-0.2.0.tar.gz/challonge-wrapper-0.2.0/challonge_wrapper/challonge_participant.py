from .challonge_helpers import fetch_raw_data, TOURNEY_URL
...
def init_participants(url, community=''):
    ...
    if community != None:
        api_url = f"{TOURNEY_URL}{community}{'-'}{url}{'/participants.json'}"
    else:
        api_url = f"{TOURNEY_URL}{url}{'/participants.json'}"
