...
class Downloader:
    def __init__(self, download_folder=None, extension=None, limit=None):
...
class GetAttachments(WebDownloader):
    def __init__(self, query, amount=None, pattern=None, credentials=None, **kwargs):
        self.query = query
        self.amount = amount
        self.pattern = pattern
        self.credentials = credentials or Path(f'{expanduser("~")}/.credentials')
