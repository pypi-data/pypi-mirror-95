...
def authorize(
    ...
    :param list scope: The scopes requested by the client. If 'openid' is in scope, this is an OpenID request. Currently the only allowed scope is 'openid' :param json:
