...
def associate_events_with_case(
    ...
    :param list events: A list of events with which to associate the specified case.Can be given in the form of AGGR/1/123456789/{UUID} or simply UUID. :param json:
...
def disassociate_events_from_case(
    ...
    :param int caseID: Case ID
    :param list events: A list of events to disassociate the specified case from. Can be given in the form of AGGR/1/123456789/{UUID} or simply UUID. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
