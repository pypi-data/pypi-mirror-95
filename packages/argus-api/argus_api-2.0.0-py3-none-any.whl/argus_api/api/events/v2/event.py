...
def submit_events(
    ...
    :param list associatedCases: Add one or more case associations to an event, not required. If set, the associated case must be readable for the current user, and must belong to the same customer as this event. :param json:
    ...
    # Only send associatedCases if the argument was provided, dont send null values
    if associatedCases is not None:
        body.update({"associatedCases": associatedCases})
