...
def add_contact(
    ...
    :param dict smsSettings: :param json:
...
def add_contact_service(
    ...
    :param str service: The service to enable for this contact :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_contact(
    ...
    :param int id: Contact ID:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def list_contacts(
    ...
    :param int offset: Skip results:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def remove_contact_service(
    ...
    :param int contactID: ID of contact
    :param str service: Name of service to disable:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_contacts(
    ...
    :param int offset: Skip search results (default 0):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
