...
def add_document_fragment(
    ...
    :param int idx: Fragment index:param json:
...
def complete_document_upload(
    ...
    :param dict notificationOptions: :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def disard_document_upload(
    ...
    :param int documentID: Document ID (as returned from the prepare endpoint):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
