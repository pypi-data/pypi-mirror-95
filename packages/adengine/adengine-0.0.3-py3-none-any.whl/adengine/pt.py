...
def extract_data(session: PacketTracerSession, filepath: str, password: str = None, timeout=10,
    ...
    Args:
        ...
        filepath: Path to activity file.
        password: Password for the provided activity file.
        timeout: Timeout for ADE - time to wait when the message "Can not read this file" appears before decide that it is not an activity file (in seconds).
        net_stabilization_delay: Delay for net stabilization (in seconds).
    ...
    Raises:
        ...
        TopologyFilesNotSupported: when topology file was provided instead of activity file.
    """
    return _extract_data(session.port, filepath, password, timeout, net_stabilization_delay=net_stabilization_delay)
