...
class Task:
    ...
    activity: bytes
    password: str
    extract_timeout: datetime.timedelta
    net_stabilization_delay: datetime.timedelta
...
class Worker:
    ...
    """
    def __init__(self, queue: mp.Queue, result_pool: dict, work_dir: str, use_virtual_display=False,
        ...
        while True:
            ...
            try:
                data = extract_data(self._session,
                                    self._filepath,
                                    task.password,
                                    int(task.extract_timeout.total_seconds()),
                                    int(task.net_stabilization_delay.total_seconds()))
...
class Scheduler:
    ...
    """
    def __init__(self, queue_size: int, workers_num: int, use_virtual_display=False,
    ...
    def put(self, activity: bytes, password: str, extract_timeout: datetime.timedelta,
            net_stabilization_delay=datetime.timedelta(seconds=0)) -> str:
        """Puts task in queue.
        ...
        Args:
            ...
            extract_timeout: Timeout for data extraction.
        ...
        with self._put_lock:
            ...
            task = Task(activity, password, extract_timeout, net_stabilization_delay)
