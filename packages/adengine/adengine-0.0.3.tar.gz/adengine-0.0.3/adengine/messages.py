...
class TaskMessage(Message):
    ...
    def __init__(self, activity: bytes, password: str or None, activity_type: ActivityTypes):
    ...
    def _from_json(cls, data: dict) -> 'TaskMessage':
        return cls(
            ...
            data['password'],
            ActivityTypes[data['activity_type'].upper()],
        )
    ...
    @property
    def activity_type(self) -> ActivityTypes:
...
class ResultMessage(Message):
    ...
    def _to_json(self) -> dict:
        return {
            'consumed_time': {
                'seconds': self._activity_data.consumed_time.seconds,
                'microseconds': self._activity_data.consumed_time.microseconds,
            },
    ...
    def _from_json(cls, data: dict) -> 'ResultMessage':
        return cls(
            ActivityData(
                datetime.timedelta(
                    seconds=data['consumed_time']['seconds'],
                    microseconds=data['consumed_time']['microseconds'],
                ),
