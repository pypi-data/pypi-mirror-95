...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '3.7.0-alpha.1613744706+2662ef8c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 3.7.0-alpha.1613744706+2662ef8c`
                """)
            else:
                raise
