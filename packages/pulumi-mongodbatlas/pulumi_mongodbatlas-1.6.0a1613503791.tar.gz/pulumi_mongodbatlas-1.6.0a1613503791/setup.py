...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '1.6.0-alpha.1613503791+09d9292f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 1.6.0-alpha.1613503791+09d9292f`
                """)
            else:
                raise
