...
def ftp_download(hostname, username, password, filename_filter, download_name="" , download_directory='.'):
    """
    ----------------------------------------------------------------
    ...
    Parameters:
        ...
        download_name: string
            (Optional) File will download locally with this name. filename_filter is default.
    ...
    try:
        ...
        ftp.retrbinary("RETR " + filename_filter, open(os.path.join(download_directory, download_name), 'wb').write)
