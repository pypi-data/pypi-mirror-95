...
[boto3.PinpointSMSVoice 1.17.9](https://boto3.amazonaws.com/v1/documentation/api/1.17.9/reference/services/pinpoint-sms-voice.html#PinpointSMSVoice) service
compatible with
