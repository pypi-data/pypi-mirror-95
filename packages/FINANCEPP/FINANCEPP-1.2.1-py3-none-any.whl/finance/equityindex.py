...
class Backtest:
    def __init__(self, stock_index = "STOXX 600", start_date = None, end_date = None, path_to_data = None, stocks_selection = None, tickers = None):
        ...
        self.stocks_selection = stocks_selection #Possible values : None, "covid_resilient"
    ...
    def run(self):
      ...
      print("Relevant Data")
      print(self.relevant_data)
      print("Relevant Data Returns")
      print(self.relevant_data_returns)
      print("Volatilities")
