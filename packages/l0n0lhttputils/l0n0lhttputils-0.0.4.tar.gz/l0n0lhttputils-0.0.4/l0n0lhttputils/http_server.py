...
class http_server:
    def __init__(self, host: str, port: int):
        ...
        self.route_get = self.routes.get
        self.route_post = self.routes.post
        self.route_head = self.routes.head
        self.route_patch = self.routes.patch
        self.route_put = self.routes.put
        self.route_static = self.routes.static
        self.route_view = self.routes.view
