...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.6.0-alpha.1613486615+9cec5f2a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.6.0-alpha.1613486615+9cec5f2a`
                """)
            else:
                raise
