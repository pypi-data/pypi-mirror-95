...
class CfnCloudFormationProduct(
    ...
    def provisioning_artifact_parameters(
        ...
        '''
        return typing.cast(typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnCloudFormationProduct.ProvisioningArtifactPropertiesProperty", aws_cdk.core.IResolvable]]], jsii.get(self, "provisioningArtifactParameters"))
...
class CfnCloudFormationProductProps:
    ...
    def provisioning_artifact_parameters(
        ...
        return typing.cast(typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[CfnCloudFormationProduct.ProvisioningArtifactPropertiesProperty, aws_cdk.core.IResolvable]]], result)
