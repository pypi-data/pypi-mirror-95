...
class _IGraphqlApiProxy(
    ...
    def add_rds_data_source(
        ...
        *,
        ...
        return typing.cast("RdsDataSource", jsii.invoke(self, "addRdsDataSource", [id, database_cluster, secret_store, options]))
...
class RdsDataSourceProps(BackedDataSourceProps):
    ...
    def database_cluster(self) -> aws_cdk.aws_rds.IDatabaseCluster:
        ...
        return typing.cast(aws_cdk.aws_rds.IDatabaseCluster, result)
