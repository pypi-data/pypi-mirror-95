...
from .common import ColorsNormal
...
class Style(enum.Enum):
    ...
    WHITE = {'color': '#ffffff'}
    SHADE = {'color': '#f0f0f0'}
    RED = {'color': ColorsNormal.RED.value}
    BLUE = {'color': ColorsNormal.BLUE.value}
    GREEN = {'color': ColorsNormal.GREEN.value}
    PURPLE = {'color': ColorsNormal.PURPLE.value}
    ORANGE = {'color': ColorsNormal.ORANGE.value}
    NAVY = {'color': ColorsNormal.NAVY.value}
    GREY1 = {'color': '#F4F4F4'}   # light
    GREY2 = {'color': '#848484'}   # medium
    GREY3 = {'color': '#474747'}   # dark
    BLACK = {'color': '#000000'}
    # Text background colours
    BG_SHADE = {'backgroundColor': '#f0f0f0'}
    BG_GREY = {'backgroundColor': '#848484'}
    BG_DARK = {'backgroundColor': '#474747'}
    BG_BLACK = {'backgroundColor': '#000000'}
    BG_GREEN = {'backgroundColor': ColorsNormal.GREEN.value}
    BG_RED = {'backgroundColor': ColorsNormal.RED.value}
    # Text alignment
    LEFT = {'textAlign': 'left'}
