...
[boto3.ConnectContactLens 1.17.9](https://boto3.amazonaws.com/v1/documentation/api/1.17.9/reference/services/connect-contact-lens.html#ConnectContactLens) service
compatible with
