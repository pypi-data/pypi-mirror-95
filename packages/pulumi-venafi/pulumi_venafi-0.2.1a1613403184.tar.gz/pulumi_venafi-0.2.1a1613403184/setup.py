...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '0.2.1-alpha.1613403184+a8379502'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 0.2.1-alpha.1613403184+a8379502`
                """)
            else:
                raise
