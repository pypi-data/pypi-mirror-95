...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '0.3.1-alpha.1613484808+48caf642'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 0.3.1-alpha.1613484808+48caf642`
                """)
            else:
                raise
