...
class SessionScript(abc.ABC):
    ...
    @show_on_help.add_command("files")
    def zip_files(self, files: Iterable[path], zip_name: path, zip_format: str, base_dir: str = None, create_folder_in_zip_file: bool = False, folder_name_in_zip_file: str = None):
        """
