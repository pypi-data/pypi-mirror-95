...
class Upbit:
    ...
    def deposit(self,**kwargs):
        ...
        [Usage]
        deposit(uuid='94332e99-3a87-4a35-ad98-28b0c969f830')
        """
        query = {}
        for item in kwargs.items():
            query[item[0]] = item[1]
    ...
    def deposits_generate_coin_address(self,**kwargs):
        ...
        [Usage]
        deposits_generate_coin_address(currency='BTC')
    ...
    def deposits_coin_address(self,**kwargs):
        ...
        [Usage]
        deposits_coin_address(currency='BTC')
        """
        query = {}
        for item in kwargs.items():
            query[item[0]] = item[1]
    ...
    def candles_minutes(self,**kwargs):
        ...
        [Usage]
        candles_minutes(unit='1',market='KRW-BTC',count='1')
        """
        query = {}
        unit = 1
        for item in kwargs.items():
    ...
    def candles_days(self,**kwargs):
        ...
        [Usage]
        candles_days(market='KRW-BTC',count='1')
        """
        query = {}
        for item in kwargs.items():
            query[item[0]] = item[1]
    ...
    def candles_weeks(self,**kwargs):
        ...
        [Usage]
        candles_weeks(market='KRW-BTC',count='1')
        """
        query = {}
        for item in kwargs.items():
            query[item[0]] = item[1]
    ...
    def candles_months(self,**kwargs):
        ...
        [Usage]
        candles_months(market='KRW-BTC',count='1')
        """
        query = {}
        for item in kwargs.items():
            query[item[0]] = item[1]
    ...
    def trades_ticks(self,**kwargs):
        ...
        [Usage]
        trades_ticks(market='KRW-BTC',count='1')
        """
        query = {}
        for item in kwargs.items():
            query[item[0]] = item[1]
