...
class ImageRecognition(object):
    ...
    def send_report(self, 
        ...
        report_payload['train_loss'] = str(round(self.train_loss[-1], 3))
        report_payload['train_acc'] = str(round(self.train_acc[-1], 3))
        report_payload['train_recall'] = '-'
        report_payload['train_precision'] =  '-'
        report_payload['train_f1'] = '-'
        report_payload['val_loss'] = str(round(self.val_loss[-1], 3))
        report_payload['val_acc'] = str(round(self.val_acc[-1], 3))
        report_payload['val_recall'] = str(round(self.val_recall[-1], 3))
        report_payload['val_precision'] = str(round(self.val_precision[-1], 3))
        report_payload['val_f1'] = str(round(self.val_f1[-1], 3))
        report_payload['running_time'] = str(self.total_time)
        report_payload['cost'] = str(self.total_cost)
    ...
    def optimize(self, 
        ...
        for i in range(iteration):
            ...
            if report_mode and report_endpoint != None: 
                ...
                self.send_report(report_id, part_name, report_endpoint)
