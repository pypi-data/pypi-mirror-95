...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '1.3.0-alpha.1613504678+ebcbdfd2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 1.3.0-alpha.1613504678+ebcbdfd2`
                """)
            else:
                raise
