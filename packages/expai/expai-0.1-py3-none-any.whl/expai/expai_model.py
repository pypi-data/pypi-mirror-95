...
class ExpaiModelExplainer:
    ...
    def explain_model(self, sample_name: str = None, sample_id: str = None, indexes: list = None, shap: bool = True, lime: bool = False, target_class: str = None):
        assert sample_name is not None or sample_id is not None, "You must provide a sample name or id for the explanation"
    ...
    def explain_sample(self, sample_name: str = None, sample_id: str = None, index: list = None, shap: bool = True, lime: bool = False, target_class: str = None):
        assert sample_name is not None or sample_id is not None, "You must provide a sample name or id for the explanation"
        ...
        if response.ok:
            ...
            if 'error' in response.json().keys():
                logging.error("There was an error when explaining the sample. Please, check the details below. \n {}".format(
                    response.json()['error']))
            else:
                logging.error("There was an error when explaining the sample. Please, check the details below. \n {}".format(
    ...
    def what_if(self, original_sample: dict = None, modified_sample: dict = None, original_sample_display: dict = None, modified_sample_display: dict = None, target_class: int = None):
