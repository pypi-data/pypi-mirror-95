.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_source_auto_examples_plot_daytime_averages.py>`     to download the full example code
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/atheisen/Code/ACT/examples/plot_daytime_averages.py:30: UserWarning: Matplotlib is currently using agg, which is a non-GUI backend, so cannot show the figure.
      plt.show()
