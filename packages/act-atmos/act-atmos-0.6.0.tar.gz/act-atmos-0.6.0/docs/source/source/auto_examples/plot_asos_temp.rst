.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_source_auto_examples_plot_asos_temp.py>`     to download the full example code
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/atheisen/Code/ACT/examples/plot_asos_temp.py:23: UserWarning: Matplotlib is currently using agg, which is a non-GUI backend, so cannot show the figure.
      plt.show()
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  55.708 seconds)
