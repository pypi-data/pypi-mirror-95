        ...
        if docker_tags:
            ...
            for module_name, repo_and_tag in docker_tags.items():
                ...
                if docker_image_definition.startswith('dockerhub://'):
                    ...
                    biolib_logger.info(f"Pulling image {docker_image_name} defined on module {module_name} from Dockerhub.")
                ...
                try:
                    ...
                    for line in docker_client.images.push(f'containers.biolib.com/{repo}', tag=tag, stream=True, decode=True, auth_config=auth_config):
