...
globaldata.sources = {**globaldata.sources,**{
    "ERAINT:blpt"     : "/user/data/gent/gvo000/gvo00090/EXT/data/ERA5/by_var_nc/blpt_1hourly/blpt_1hourly*.nc:t",
    "ERAINT:blh"     : "/user/data/gent/gvo000/gvo00090/EXT/data/ERA5/by_var_nc/blh_1hourly//blh_1hourly*.nc:blh",
    "ERAINT:blq"     : "/user/data/gent/gvo000/gvo00090/EXT/data/ERA5/by_var_nc/blq_1hourly/blq_1hourly*.nc:q",
...
# for iSTN,STN in STNlist[5:]:  
    ...
    with open(fnout,'w') as fileout:
        ...
        while wy_strm.current is not None:
            ...
            # sounding
            if morning_ok == 1.:
                c4gli.update(source='pairs',pars={'runtime' : 3600.})
                c4gli.get_global_input(globaldata)
                print('VERY CLOSE...')
