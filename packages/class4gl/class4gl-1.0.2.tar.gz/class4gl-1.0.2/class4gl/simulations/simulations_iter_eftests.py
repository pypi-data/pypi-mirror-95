...
def execute(**kwargs):
    ...
    for iexpname,expid in enumerate(experiments):
        ...
        globaldata.sources = {**globaldata.sources,**{
             # "ERA5:t2m_daymax" : '/data/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/t2m_1hourly_for_t2m_daymax.nc:t2m',mm
            "ERA5:midsummermonth" : '/scratch/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/blptb_1hourly_daymean_select_for_blptb_daymean_mean3month_is_max.nc:blptb',
        ...
        for varkey in ['h','theta']:
            records_morning_station['d'+varkey+'dt'] = \
                    ...
                    (records_afternoon_station.ldatetime - records_morning_station.ldatetime).dt.seconds*3600.
        ...
        print(records_morning_station[['dhdt','dthetadt']])
        for istation,current_station in run_stations.iterrows():
            if (int(args.split_by) * int(run_station_chunk)) >= (len(records_morning_station)):
                ...
                for (STNID,chunk,index),record_morning in records_morning_station_chunk.iterrows():
                        ...
                        c4gli_morning.get_global_input(globaldata,only_keys=['blptb_daymean','blptb_daymean_ge90'])
