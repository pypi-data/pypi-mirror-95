...
def execute(**kwargs):
    ...
    EXP_DEFS  =\
    {
      ...
      'BASE_ITER_ADV_EFERA5_SM_LOW':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False},
      'BASE_ITER_ADV_EFERA5_SM_HIG':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False},
        ...
        for istation,current_station in run_stations.iterrows():
            ...
            if not skip_chunk:
                ...
                for (STNID,chunk,index),record_morning in records_morning_station_chunk.iterrows():
                        ...
                        if expname == "BASE_ITER_ADV_EFERA5_SM_LOW": 
                            c4gli_morning.update(source='BASE_ITER_ADV_EFERA5_SM_LOW',pars={'wg' : wg_low})
                            c4gli_morning.update(source='BASE_ITER_ADV_EFERA5_SM_LOW',pars={'w2' : wg_low})
                        if expname == "BASE_ITER_ADV_EFERA5_SM_HIG": 
                            c4gli_morning.update(source='BASE_ITER_ADV_EFERA5_SM_HIG',pars={'wg' : wg_hig})
                            c4gli_morning.update(source='BASE_ITER_ADV_EFERA5_SM_HIG',pars={'w2' : wg_hig})
