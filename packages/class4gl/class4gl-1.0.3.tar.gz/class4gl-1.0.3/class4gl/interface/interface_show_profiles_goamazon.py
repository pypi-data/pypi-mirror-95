...
for j,i in enumerate(select):
    ...
    profiles_morning_raw.append( c4gldata[0].frames['profiles']['record_yaml_ini'].air_balloon[::15])
    ...
    profiles_afternoon_obs_raw.append(c4gldata[0].frames['profiles']['record_yaml_end_obs'].air_balloon[::15])
...
for var in VARS:
    ...
    for i in range(numprofiles):
        ...
        plt.plot(profiles_afternoon_obs_raw[i][var].values*fac,profiles_afternoon_obs_raw[i].z.values,'nx')
