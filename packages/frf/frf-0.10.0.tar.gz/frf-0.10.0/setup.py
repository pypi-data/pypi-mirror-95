...
#
# This file is part of frf.
#
# frf is free software: you can redistribute it and/or modify
...
# along with frf.  If not, see <https://www.gnu.org/licenses/>.
import json
import os
import sys
...
opts = json.loads((open('frf/package.json').read()))
