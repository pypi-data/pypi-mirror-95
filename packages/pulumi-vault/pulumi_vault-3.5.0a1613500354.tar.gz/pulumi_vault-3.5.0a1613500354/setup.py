...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '3.5.0-alpha.1613500354+822017e6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 3.5.0-alpha.1613500354+822017e6`
                """)
            else:
                raise
