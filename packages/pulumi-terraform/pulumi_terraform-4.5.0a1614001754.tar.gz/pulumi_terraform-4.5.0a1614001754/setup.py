...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '4.5.0-alpha.1614001754+a795bb59'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 4.5.0-alpha.1614001754+a795bb59`
                """)
