...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, topdir):
        ...
        gAddBAction.triggered.connect(lambda: self.gTable.insertRow(self.gTable.currentRow()))
        self.gMenu.addAction(gAddBAction)
        gAddAAction = QtWidgets.QAction("Add row after", self)
        gAddAAction.triggered.connect(lambda: self.gTable.insertRow(self.gTable.currentRow() + 1))
