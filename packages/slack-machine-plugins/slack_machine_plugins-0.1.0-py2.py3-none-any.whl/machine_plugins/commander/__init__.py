...
class CommandArgument:
    ...
    def __assert_choices(self) -> None:
        """If choices are provided, ensure that they can be converted to target_type.
        ...
        for choice in self.choices:
            try:
                ...
                raise ValueError(f'Provided choice "{choice}" can\'t be converted to target type {self.target_type}')
    ...
    def errors(self, input: str) -> Optional[str]:
        ...
        except ValueError:  # no choices defined, can't convert to target type
            return f'Provided input "{input}" can\'t be converted to target type {self.target_type}'
        # no choices defined and can convert, return None
        return None
