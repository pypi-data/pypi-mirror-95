...
- direction (a value equal to: "left", "right"; optional): Which direction should the button indicate?
- disabled (boolean; optional): If `true`, the element is disabled.
- orientation (a value equal to: "horizontal", "vertical"; optional): The tabs orientation (layout flow direction).
