...
- orientation (a value equal to: "horizontal", "vertical"; optional): The group orientation (layout flow direction).
- size (a value equal to: "small", "medium", "large"; optional): The size of the buttons.
