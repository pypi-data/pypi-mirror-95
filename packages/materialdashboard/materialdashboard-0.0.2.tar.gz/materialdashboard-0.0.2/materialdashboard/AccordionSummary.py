...
Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): The content of the accordion summary.
...
- disabled (boolean; optional): If `true`, the base button is disabled.
