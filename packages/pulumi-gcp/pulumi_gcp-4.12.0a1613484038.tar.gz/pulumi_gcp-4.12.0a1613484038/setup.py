...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '4.12.0-alpha.1613484038+d4cdc73e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 4.12.0-alpha.1613484038+d4cdc73e`
                """)
            else:
                raise
