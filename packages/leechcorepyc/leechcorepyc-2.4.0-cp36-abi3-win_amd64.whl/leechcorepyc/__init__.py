...
LC_CMD_FPGA_WRITE_TLP                       = 0x0000010100000000  # R
LC_CMD_FPGA_LISTEN_TLP                      = 0x0000010200000000  # R
...
LC_CMD_AGENT_EXIT_PROCESS                   = 0x8000000200000000  # N/A - [lo-dword: process exit code]
