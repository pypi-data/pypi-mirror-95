...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.9.0-alpha.1613500359+09e461ee'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.9.0-alpha.1613500359+09e461ee`
                """)
            else:
                raise
