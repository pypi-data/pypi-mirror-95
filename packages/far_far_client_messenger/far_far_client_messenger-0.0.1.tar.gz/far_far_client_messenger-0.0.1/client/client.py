...
from client.client_database import Client_DB
...
if __name__ == '__main__':
    ...
    if not client_name or not client_passwd:
        ...
        if start_dialog.ok_pressed:
            ...
            LOG_CLIENT.debug(f'Using USERNAME = {client_name}, '
    ...
    LOG_CLIENT.debug("Keys successfully loaded.")
    ...
    try:
        transport = ClientTransport(
            ...
            client_passwd,
            keys)
        LOG_CLIENT.debug("Transport ready.")
