...
class Client_DB:
    ...
    def __init__(self, name):
        ...
        mapper(self.HistoryMessage, history)
    ...
    def save_msg(self, contact, direction, message):
        ...
        message_row = self.HistoryMessage(contact, direction, message)
