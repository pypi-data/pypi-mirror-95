...
setup(
  ...
  long_description="""
    Documentation Link: https://github.com/onesinus/datatable-server-side-django3/blob/main/README.md
  """,
  long_description_content_type="text/markdown",
  author = 'Onesinus SPT',
  author_email = 'onesinus231@gmail.com',
  url = 'https://github.com/onesinus/datatable-server-side-django3',
  download_url = 'https://github.com/onesinus/datatable-server-side-django3/archive/0.0.5.zip',
