...
layers. If a names list is not supplied, the names of the exported masters will
be constructed using the abbreviated axis names as set in the font (accessible
via the master font's axis attribute).
