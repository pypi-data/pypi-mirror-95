...
class BertTagger:
    ...
    @staticmethod
    def save_pretrained_model(bert_model: str, save_dir: str, state_dict: json = None, logger: logging.Logger = None, cache_dir: str = ""):
    ...
    @staticmethod
    def download_pretrained_models(bert_models: List[str], save_dir: str, logger: logging.Logger = None, cache_dir: str = ""):
        ...
        for bert_model in bert_models:
            try:
                ...
                BertTagger.save_pretrained_model(bert_model, save_dir, logger=logger, cache_dir = cache_dir)
            except:
