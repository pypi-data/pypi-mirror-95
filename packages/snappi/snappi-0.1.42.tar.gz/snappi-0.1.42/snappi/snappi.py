...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureFilter, CaptureIpv4, CaptureVlan, CaptureEthernet, CaptureCustom]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowHeader, FlowPpp, FlowPfcPause, FlowGtpv1, FlowGtpv2, FlowTcp, FlowVxlan, FlowIgmpv1, FlowEthernetPause, FlowCustom, FlowEthernet, FlowIpv6, FlowUdp, FlowArp, FlowGre, FlowVlan, FlowIpv4]
        return self._getitem(key)
