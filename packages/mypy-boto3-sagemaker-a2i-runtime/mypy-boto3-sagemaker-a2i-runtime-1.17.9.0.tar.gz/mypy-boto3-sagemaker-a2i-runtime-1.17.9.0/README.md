...
[boto3.AugmentedAIRuntime 1.17.9](https://boto3.amazonaws.com/v1/documentation/api/1.17.9/reference/services/sagemaker-a2i-runtime.html#AugmentedAIRuntime) service
compatible with
