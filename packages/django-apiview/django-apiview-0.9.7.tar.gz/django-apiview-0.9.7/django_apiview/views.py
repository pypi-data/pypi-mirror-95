...
class Apiview(object):
    def __init__(self, packer, preload_plugins=None, extra_parameters=None, enable_api_response_time_log=None):
        self.packer = packer
        self.extra_parameters = extra_parameters or {}
        self.preload_plugins = preload_plugins or []
        if enable_api_response_time_log is None:
            enable_api_response_time_log = getattr(settings, "DJANGO_APIVIEW_ENABLE_API_RESPONSE_TIME_LOG", False)
...
@apiview
@check_aclkey()
def updateApiResponseTimeStats():
    from .models import ApiResponseTimeStats
    return ApiResponseTimeStats.update()
