...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.11.0-alpha.1613757811+4b8b85ee'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.11.0-alpha.1613757811+4b8b85ee`
                """)
            else:
                raise
