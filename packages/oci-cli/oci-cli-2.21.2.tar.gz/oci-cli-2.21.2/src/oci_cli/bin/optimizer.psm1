...
function GetOciSubcommands_optimizer() {
    $ociSubcommands = @{
        'optimizer' = 'category category-summary enrollment-status enrollment-status-summary history-summary profile profile-summary recommendation recommendation-summary resource-action resource-action-summary work-request work-request-error work-request-log-entry'
...
function GetOciCommandsToLongParams_optimizer() {
    $ociCommandsToLongParams = @{
        ...
        'optimizer profile create' = 'compartment-id defined-tags description freeform-tags from-json help levels-configuration max-wait-seconds name wait-for-state wait-interval-seconds'
        ...
        'optimizer profile update' = 'defined-tags description force freeform-tags from-json help if-match levels-configuration max-wait-seconds profile-id wait-for-state wait-interval-seconds'
        ...
        'optimizer recommendation bulk-apply' = 'from-json help max-wait-seconds recommendation-id resource-action-ids status time-status-end wait-for-state wait-interval-seconds'
