...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['curators_id'], ['accounts_role.id'], name=op.f('fk_oarepo_communities_curators_id_accounts_role'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['members_id'], ['accounts_role.id'], name=op.f('fk_oarepo_communities_members_id_accounts_role'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['publishers_id'], ['accounts_role.id'], name=op.f('fk_oarepo_communities_publishers_id_accounts_role'), ondelete='CASCADE'),
