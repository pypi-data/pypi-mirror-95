class AbsMilvus:
    ...
    def load_collection(self, collection_name, db_name, timeout=None):
        """
        ...
        :param db_name: db for collection
    ...
    def release_collection(self, collection_name, db_name, timeout=30):

        pass

    def load_partitions(self, db_name, collection_name, partition_names):

        pass

    def release_partitions(self, db_name, collection_name, partition_names):
