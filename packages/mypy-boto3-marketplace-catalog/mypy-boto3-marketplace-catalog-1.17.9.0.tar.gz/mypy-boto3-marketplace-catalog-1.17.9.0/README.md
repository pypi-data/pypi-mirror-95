...
[boto3.MarketplaceCatalog 1.17.9](https://boto3.amazonaws.com/v1/documentation/api/1.17.9/reference/services/marketplace-catalog.html#MarketplaceCatalog) service
compatible with
