...
class Projection:
    ...
    def __call__(self, *args, invert=False):
        ...
        if len(args) == 2 or (len(args) == 3 and self.PROJ4 == 'ortho'):
            return self.lonlat(*args) if invert else self.xy(*args)  # pylint: disable=no-value-for-parameter  # noqa: E501
