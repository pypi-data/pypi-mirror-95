...
class Operation(GrapheneOperation):
    """Need to overwrite a few attributes to load proper operations from africunia."""

    module = "africuniabase.operations"
    operations = operations


class ObjectId(GPHObjectId):
    """Need to overwrite a few attributes to load proper object_types from africunia."""
