...
from africuniabase import operations
...
class Market(dict):
    ...
    :param africunia.africunia.AfrIcunia blockchain_instance: AfrIcunia instance
    :param africunia.asset.Asset base: Base asset
    :param africunia.asset.Asset quote: Quote asset
    ...
    * ``base`` and ``quote`` are valid assets (according to :class:`africunia.asset.Asset`)
    * ``base:quote`` separated with ``:``
    * ``base/quote`` separated with ``/``
    * ``base-quote`` separated with ``-``

    .. note:: Throughout this library, the ``quote`` symbol will be
              presented first (e.g. ``USD:AFCASH`` with ``USD`` being the
              quote), while the ``base`` only refers to a secondary asset
              for a trade. This means, if you call
              :func:`africunia.market.Market.sell` or
              :func:`africunia.market.Market.buy`, you will sell/buy **only
    ...
    def get_string(self, separator=":"):
        """
        Return a formated string that identifies the market, e.g. ``USD:AFCASH``
    ...
    def ticker(self):
        ...
        * ``core_exchange_rate``: Core exchange rate for payment of fee in non-AFCASH asset
    ...
    def orderbook(self, limit=25):
        ...
        .. code-block:: js
            ...
            {'bids': [0.003679 USD/AFCASH (1.9103 USD|519.29602 AFCASH),
            0.003676 USD/AFCASH (299.9997 USD|81606.16394 AFCASH),
            0.003665 USD/AFCASH (288.4618 USD|78706.21881 AFCASH),
            0.003665 USD/AFCASH (3.5285 USD|962.74409 AFCASH),
            0.003665 USD/AFCASH (72.5474 USD|19794.41299 AFCASH)],
            'asks': [0.003738 USD/AFCASH (36.4715 USD|9756.17339 AFCASH),
            0.003738 USD/AFCASH (18.6915 USD|5000.00000 AFCASH),
            0.003742 USD/AFCASH (182.6881 USD|48820.22081 AFCASH),
            0.003772 USD/AFCASH (4.5200 USD|1198.14798 AFCASH),
            0.003799 USD/AFCASH (148.4975 USD|39086.59741 AFCASH)]}


        .. note:: Each bid is an instance of
            class:`africunia.price.Order` and thus carries the keys
    ...
    def get_limit_orders(self, limit=25):
        ...
        .. code-block:: js
            ...
            [0.003679 USD/AFCASH (1.9103 USD|519.29602 AFCASH),
            0.003676 USD/AFCASH (299.9997 USD|81606.16394 AFCASH),
            0.003665 USD/AFCASH (288.4618 USD|78706.21881 AFCASH),
            0.003665 USD/AFCASH (3.5285 USD|962.74409 AFCASH),
            0.003665 USD/AFCASH (72.5474 USD|19794.41299 AFCASH),
            [0.003738 USD/AFCASH (36.4715 USD|9756.17339 AFCASH),
            0.003738 USD/AFCASH (18.6915 USD|5000.00000 AFCASH),
            0.003742 USD/AFCASH (182.6881 USD|48820.22081 AFCASH),
            0.003772 USD/AFCASH (4.5200 USD|1198.14798 AFCASH),
            0.003799 USD/AFCASH (148.4975 USD|39086.59741 AFCASH)]
    ...
    def accountopenorders(self, account=None):
        ...
        :param africunia.account.Account account: Account name or instance of Account to show orders for in this market
        """
        if not account:
            if "default_account" in self.blockchain.config:
                account = self.blockchain.config["default_account"]
    ...
    def buy(
        ...
        **kwargs
        ...
        is priced in AFCASH per USD.

        **Example:** in the USD_BTS market, a price of 300 means
        a USD is worth 300 AFCASH

        .. note::

            All prices returned are in the **reversed** orientation as the
            market. I.e. in the BTC/AFCASH market, prices are AFCASH per BTC.
        ...
        .. warning::
            ...
            for. Example:
                ...
                * You place and order to buy 10 USD for 100 AFCASH/USD
                * This means that you actually place a sell order for 1000 AFCASH in order to obtain **at least** 10 USD
