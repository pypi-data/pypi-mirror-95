...
from africuniabase.account import PrivateKey, PublicKey
...
class Memo(GrapheneMemo):
    ...
    :param africunia.aio.account.Account from_account: Account that has sent
        the memo
    :param africunia.aio.account.Account to_account: Account that has received
        the memo
    ...
    .. code-block:: python
        ...
        from africunia.aio.memo import Memo
