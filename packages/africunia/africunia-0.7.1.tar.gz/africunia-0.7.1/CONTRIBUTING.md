...
You are here to help AfrIcunia and the python-africunia library?
...
tracker][https://github.com/africunia/python-africunia/issues] to see if
someone else in the community has already created a ticket. If not, go
ahead and [make one][https://github.com/africunia/python-africunia/issues/new]!
...
* **Ensure the bug was not already reported** by [searching all issues][https://github.com/africunia/python-africunia/issues].

* If you're unable to find an open issue addressing the problem,
  [open a new one][https://github.com/africunia/python-africunia/issues/new]. Be sure
...
[Codeclimate](https://codeclimate.com/github/africunia/python-africunia)
will give you feedback in this regard. You can check & fix codeclimate's
feedback by running it locally using [Codeclimate's CLI](https://codeclimate.com/github/africunia/python-africunia), via
`codeclimate analyze`.
...
sure it's up to date with python-africunia's `develop` branch:

    git remote add upstream git@github.com:africunia/python-africunia.git
