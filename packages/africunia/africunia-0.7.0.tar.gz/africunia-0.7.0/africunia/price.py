...
class Price(GraphenePrice):
    ...
    with the tuple::
        ...
        Way to obtain a proper instance:
            ...
            * ``args`` can be a floating number and ``base`` and ``quote`` being instances of :class:`africunia.asset.Asset`
            ...
            * ``args`` being a list of ``[quote, base]`` both being instances of :class:`africunia.amount.Amount`
            * ``args`` being a list of ``[quote, base]`` both being instances of ``str`` (``amount symbol``)
            * ``base`` and ``quote`` being instances of :class:`africunia.asset.Amount`
        ...
        * ``Price(1.0, "USD/GOLD")``
        ...
        .. code-block:: python
            ...
            >>> from africunia.price import Price
            >>> Price("0.3314 USD/AFCASH") * 2
    ...
    def market(self):
        ...
        :returns: Instance of :class:`africunia.market.Market` for the
...
class Order(Price):
    """
    This class inherits :class:`africunia.price.Price` but has the ``base`` and
