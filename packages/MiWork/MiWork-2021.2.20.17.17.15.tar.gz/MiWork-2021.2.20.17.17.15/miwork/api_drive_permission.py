...
from miwork.dt_drive import DriveFilePermission, unmarshal_drive_user_permission
from miwork.helper import converter_enum

if TYPE_CHECKING:
    from miwork.api import OpenLark
    from miwork.dt_drive import DriveFileUserPermission, DriveFileToken, DriveFileUser, \
