...
class Feishu(object):
    ...
    def send_by_post(self, chat='PUSH算法组', title='我是一个标题', text='我是一条文本', at_user='yuanjie@xiaomi.com'):
        """发送富文本信息
    ...
    def send_by_df_card(self, chat='PUSH算法组',
        ...
        dfi.export(df.style.background_gradient(), 'img.png', table_conversion='', max_rows=-1, max_cols=-1)
