...
Starting from version 2021.02.09, you can use youtube-dlc -U to update
if you are using the provided release. If you are using pip, simply
re-run the same command that was used to install the program.
